//app/api/mobile/translation/ai/route.ts
import { NextRequest, NextResponse } from "next/server";
import { chatCompletion } from "@/lib/ai";
import {
  canPerformAction, consumePoints, hasPermission,
  getUserPlanData, logAiUsage,
} from "@/lib/plans";
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      await logAiUsage(userId, "AI_TRANSLATION");
    ...
    console.error("mobile translation/ai error:", err);
    return NextResponse.json(
