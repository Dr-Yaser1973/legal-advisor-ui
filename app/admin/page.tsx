    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-zinc-400 max-w-2xl">
          من هذه الواجهة يمكنك إدارة المحتوى القانوني في المكتبة، مراجعة وتفعيل
          حسابات المستخدمين والمحامين، ومتابعة طلبات الاستشارات القانونية.
        </p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        >
          <div className="flex items-center justify-between gap-3 mb-3">
            <div>
              <h3 className="text-base font-semibold">إدارة المكتبة القانونية</h3>
          ...
          <p className="text-[11px] text-zinc-500 mt-2">
            استخدم هذه الصفحة لمتابعة محتوى المكتبة وضبط جودته قبل ظهوره للمستخدمين.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-[11px] text-zinc-500 mt-2">
            هذه الصفحة هي مركز التحكم في من يمكنه دخول المنصة، وما هي الصلاحيات
            الممنوحة له.
          </p>
        </Link>
        ...
        >
          <div className="flex items-center justify-between gap-3 mb-3">
            <div>
              <h3 className="text-base font-semibold">الاستشارات القانونية</h3>
              <p className="text-xs text-zinc-400 mt-1">
