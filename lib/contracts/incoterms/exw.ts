...
export const EXW_AR: ContractTemplate = {
  ...
  fields: [
    ...
    { key: "deliveryPlace", label: "مكان التسليم", required: true, type: "text", group: "التسليم",
      placeholder: "مصنع البائع، مستودعه، مقره..." },
    { key: "deliverySchedule", label: "موعد/فترة التسليم", required: true, type: "text", group: "التسليم" },
    { key: "packaging", label: "التعبئة والتغليف", required: false, type: "textarea", group: "التسليم" },
    { key: "marking", label: "الوسم/العلامات", required: false, type: "text", group: "التسليم" },
    { key: "documentsList", label: "المستندات المطلوبة", required: true, type: "textarea", group: "المستندات والفحص",
      placeholder: "الفاتورة التجارية، قائمة التعبئة، شهادة المنشأ" },
...
export const EXW_EN: ContractTemplate = {
  ...
  group: "INCOTERMS",
   fields: [
    ...
    // EXW-specific
    { key: "deliveryPlace", label: "Place of Delivery", required: true, type: "text", group: "Delivery",
      placeholder: "Seller's factory, warehouse, premises..." },
    { key: "deliverySchedule", label: "Delivery Date/Period", required: true, type: "text", group: "Delivery" },
    { key: "packaging", label: "Packaging", required: false, type: "textarea", group: "Delivery" },
    { key: "marking", label: "Marking", required: false, type: "text", group: "Delivery" },
    { key: "documentsList", label: "Required Documents", required: true, type: "textarea", group: "Documents & Inspection",
      placeholder: "Commercial invoice, packing list, certificate of origin" },
