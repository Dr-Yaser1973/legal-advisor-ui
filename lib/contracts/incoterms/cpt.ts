...
export const CPT_AR: ContractTemplate = {
  id: 2080,
  slug: "incoterms-cpt-premium-ar",
  title: "عقد بيع دولي – CPT (Incoterms®)",
  lang: "ar",
  group: "INCOTERMS",
...
<h1>عقد بيع دولي وفق شرط CPT (Incoterms® {{incotermsEdition}})</h1>
<div class="meta">
...
<div class="box">
  ...
  <p>يُقصد بشرط <b>CPT (النقل مدفوع حتى)</b> ما ورد تعريفه في <b>قواعد Incoterms® {{incotermsEdition}}</b> الصادرة عن ICC.</p>
  <p class="small">
    CPT = FCA + البائع يدفع أجرة النقل حتى مكان الوصول المحدد. لكن الخطر ينتقل إلى المشتري
    عند تسليم البضاعة للناقل الأول — لا عند الوصول. التأمين مسؤولية المشتري.
    مناسب لجميع وسائط النقل بما فيها الحاويات.
  </p>
</div>
...
<div class="box">
  <h2>رابعاً: التسليم والنقل وفق CPT</h2>
  <table>
  ...
  <ul>
    ...
    <li>في حالة النقل المتعدد الوسائط: ينتقل الخطر عند التسليم للناقل الأول وليس عند تغيير وسيلة النقل.</li>
  </ul>
</div>

<div class="box">
  <h2>خامساً: انتقال المخاطر والتأمين</h2>
  <ul>
    <li>تنتقل مخاطر الهلاك أو التلف عند تسليم البضاعة للناقل في <b>{{placeOfHandover}}</b> — لا عند الوصول إلى <b>{{namedDestination}}</b>.</li>
    <li>لا يلتزم البائع بالتأمين في CPT — المشتري مسؤول وحده عن تأمين البضاعة.</li>
    <li>يُنصح المشتري بإبرام وثيقة تأمين تغطي الرحلة من مكان التسليم للناقل حتى الوجهة النهائية.</li>
  </ul>
</div>
...
export const CPT_EN: ContractTemplate = {
  id: 2081,
  slug: "incoterms-cpt-premium-en",
  title: "International Sale Contract – CPT (Incoterms®)",
  lang: "en",
  group: "INCOTERMS",
...
<div class="box">
  ...
  <p>The term <b>CPT (Carriage Paid To)</b> shall be interpreted in accordance with <b>Incoterms® {{incotermsEdition}}</b> issued by the ICC.</p>
  <p class="small">
    CPT = FCA + Seller pays freight to the named destination. Risk transfers to Buyer when Goods are
    handed to the first carrier — NOT upon arrival. Insurance is Buyer's responsibility.
    Suitable for all modes of transport including containerised shipments.
  </p>
</div>
...
<div class="box">
  <h2>4. Delivery and Transport – CPT</h2>
  <table>
  ...
  <ul>
    ...
    <li>For multimodal transport: risk transfers at handover to the first carrier, not at each transshipment point.</li>
  </ul>
</div>

<div class="box">
  <h2>5. Risk Transfer and Insurance</h2>
  <ul>
    <li>Risk passes at <b>{{placeOfHandover}}</b> upon handover to the first carrier — NOT upon arrival at <b>{{namedDestination}}</b>.</li>
    <li>Seller has no obligation to procure insurance under CPT. Buyer is solely responsible.</li>
    <li>Buyer is strongly advised to obtain cargo insurance covering the entire transit.</li>
  </ul>
</div>
