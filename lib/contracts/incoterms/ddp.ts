...
export const DDP_AR: ContractTemplate = {
  ...
  fields: [
    ...
    // DDP-specific
    { key: "placeOfDelivery", label: "مكان التسليم المحدد", required: true, type: "text", group: "التسليم والتخليص",
      placeholder: "مستودع المشتري، العنوان النهائي..." },
    { key: "deliverySchedule", label: "جدول التسليم", required: true, type: "text", group: "التسليم والتخليص" },
    { key: "destinationCountry", label: "دولة الوصول", required: true, type: "text", group: "التسليم والتخليص" },
    { key: "modeOfTransport", label: "وسيلة النقل", required: false, type: "select", group: "التسليم والتخليص",
      options: ["بري", "بحري", "جوي", "متعدد الوسائط"] },
    { key: "unloadingResponsibility", label: "مسؤولية التفريغ عند الوصول", required: true, type: "textarea", group: "التسليم والتخليص",
      placeholder: "وفق DDP البائع لا يلتزم بالتفريغ ما لم يُتفق على خلافه" },
    // DDP customs & duties
    { key: "customsBroker", label: "وكيل التخليص الجمركي", required: false, type: "text", group: "التخليص الجمركي والرسوم",
      placeholder: "اسم شركة التخليص في دولة الوصول" },
    { key: "importDutiesTaxes", label: "الرسوم والضرائب المستحقة على الاستيراد", required: true, type: "textarea", group: "التخليص الجمركي والرسوم",
      placeholder: "يتحملها البائع بالكامل وفق DDP" },
    { key: "importLicenses", label: "تراخيص وموافقات الاستيراد", required: false, type: "textarea", group: "التخليص الجمركي والرسوم",
      placeholder: "التراخيص المطلوبة للاستيراد في دولة الوصول" },
    { key: "titleTransferClause", label: "بند انتقال الملكية", required: false, type: "textarea", group: "التخليص الجمركي والرسوم",
      placeholder: "تنتقل الملكية عند إتمام التسليم في مكان الوصول" },
    { key: "documentsList", label: "المستندات المطلوبة", required: true, type: "textarea", group: "المستندات والفحص",
      placeholder: "الفاتورة، وثيقة النقل، وثيقة التخليص الجمركي، شهادة المنشأ" },
...
export const DDP_EN: ContractTemplate = {
  ...
  fields: [
    ...
    // DDP-specific
    { key: "placeOfDelivery", label: "Named Place of Delivery", required: true, type: "text", group: "Delivery & Clearance",
      placeholder: "Buyer's warehouse, final address..." },
    { key: "deliverySchedule", label: "Delivery Schedule", required: true, type: "text", group: "Delivery & Clearance" },
    { key: "destinationCountry", label: "Destination Country", required: true, type: "text", group: "Delivery & Clearance" },
    { key: "modeOfTransport", label: "Mode of Transport", required: false, type: "select", group: "Delivery & Clearance",
      options: ["Road", "Sea", "Air", "Multimodal"] },
    { key: "unloadingResponsibility", label: "Unloading Responsibility", required: true, type: "textarea", group: "Delivery & Clearance",
      placeholder: "Under DDP Seller is not obliged to unload unless otherwise agreed" },
    // DDP customs & duties
    { key: "customsBroker", label: "Customs Broker/Agent", required: false, type: "text", group: "Import Clearance & Duties",
      placeholder: "Name of clearing agent in destination country" },
    { key: "importDutiesTaxes", label: "Import Duties & Taxes", required: true, type: "textarea", group: "Import Clearance & Duties",
      placeholder: "Borne entirely by Seller under DDP" },
    { key: "importLicenses", label: "Import Licenses & Permits", required: false, type: "textarea", group: "Import Clearance & Duties",
      placeholder: "Licenses required for import in destination country" },
    { key: "titleTransferClause", label: "Title Transfer Clause", required: false, type: "textarea", group: "Import Clearance & Duties",
      placeholder: "Title passes upon delivery at named destination" },
    { key: "documentsList", label: "Required Documents", required: true, type: "textarea", group: "Documents & Inspection",
      placeholder: "Commercial invoice, transport document, customs clearance, certificate of origin" },
