// lib/contracts/ae/partnership.ts
// عقد شركة/شراكة وفق قانون المعاملات المدنية الاتحادي الإماراتي رقم 5 لسنة 1985 (أحكام الشركة).
// للشركات التجارية تُراعى أيضاً أحكام المرسوم بقانون اتحادي رقم 32 لسنة 2021 بشأن الشركات التجارية.
...
export const PARTNERSHIP_AE_AR: ContractTemplate = {
  id: 5401,
  slug: "ae-partnership-ar",
  title: "عقد شراكة (الإمارات) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "partner1Id", label: "الهوية/الرخصة للشريك الأول", required: true, type: "text", group: "الشركاء" },
    ...
    { key: "partner2Id", label: "الهوية/الرخصة للشريك الثاني", required: true, type: "text", group: "الشركاء" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية الاتحادي رقم 5 لسنة 1985 (وقانون الشركات التجارية 32/2021 عند الاقتضاء)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الشريك الأول:</b> {{partner1Name}} — الهوية/الرخصة: {{partner1Id}} — العنوان: {{partner1Address}}</div>
    <div class="p"><b>الشريك الثاني:</b> {{partner2Name}} — الهوية/الرخصة: {{partner2Id}} — العنوان: {{partner2Address}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يُقسَّم له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يقع باطلاً كل شرط يقضي بحرمان أحد الشركاء من الربح أو بإعفائه من المساهمة في الخسارة (شرط الأسد).</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (وقانون الشركات التجارية إن كانت الشركة تجارية).</li>
...
export const PARTNERSHIP_AE_EN: ContractTemplate = {
  id: 5402,
  slug: "ae-partnership-en",
  title: "Partnership Agreement (UAE) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "partner1Id", label: "Partner 1 ID / Licence", required: true, type: "text", group: "Partners" },
    ...
    { key: "partner2Id", label: "Partner 2 ID / Licence", required: true, type: "text", group: "Partners" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the UAE Civil Transactions Law No. 5 of 1985 (and Commercial Companies Law 32/2021 where applicable).</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Partners</h3>
    <div><b>Partner 1:</b> {{partner1Name}} — ID/Licence: {{partner1Id}} — {{partner1Address}}</div>
    <div><b>Partner 2:</b> {{partner2Name}} — ID/Licence: {{partner2Id}} — {{partner2Address}}</div>
  ...
  <div class="sec"><h3>3. Capital & Contributions</h3><div class="box">
    ...
    <div class="muted">A contribution of work earns a share of profit per agreement but does not form part of the capital.</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Profit, Loss & Management</h3><div class="box">
    ...
    <div class="muted">Any clause excluding a partner from profit or from contributing to loss is void (leonine clause).</div>
  </div></div>
