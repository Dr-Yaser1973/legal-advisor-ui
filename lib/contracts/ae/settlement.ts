// lib/contracts/ae/settlement.ts
// عقد صلح وفق قانون المعاملات المدنية الاتحادي الإماراتي رقم 5 لسنة 1985 (أحكام الصلح).
...
export const SETTLEMENT_AE_AR: ContractTemplate = {
  id: 6101,
  slug: "ae-settlement-ar",
  title: "عقد صلح (الإمارات) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "party1Id", label: "الهوية/الرخصة للطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "الهوية/الرخصة للطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="p"><b>الطرف الأول:</b> {{party1Name}} — الهوية/الرخصة: {{party1Id}} — العنوان: {{party1Address}}</div>
    <div class="p"><b>الطرف الثاني:</b> {{party2Name}} — الهوية/الرخصة: {{party2Id}} — العنوان: {{party2Address}}</div>
  </div>
...
export const SETTLEMENT_AE_EN: ContractTemplate = {
  id: 6102,
  slug: "ae-settlement-en",
  title: "Settlement Agreement (UAE) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "party1Id", label: "Party 1 ID / Licence", required: true, type: "text", group: "Party 1" },
    ...
    { key: "party2Id", label: "Party 2 ID / Licence", required: true, type: "text", group: "Party 2" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Party 1:</b> {{party1Name}} — ID/Licence: {{party1Id}} — {{party1Address}}</div>
    <div><b>Party 2:</b> {{party2Name}} — ID/Licence: {{party2Id}} — {{party2Address}}</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Effect</h3><div class="box">
    <div class="muted">The rights waived by each party are extinguished definitively; the settlement conclusively resolves the matters it covers and may not be rescinded except on grounds fixed by law.</div>
  </div></div>
