// lib/contracts/ae/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق قانون المعاملات المدنية الاتحادي الإماراتي رقم 5 لسنة 1985
// (أحكام الرهن الحيازي والتأمينات العينية).
...
export const PLEDGE_AE_AR: ContractTemplate = {
  id: 5701,
  slug: "ae-pledge-ar",
  title: "عقد رهن حيازي (الإمارات) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "pledgorId", label: "الهوية/الرخصة للراهن", required: true, type: "text", group: "الراهن" },
    ...
    { key: "pledgeeId", label: "الهوية/الرخصة للمرتهن", required: true, type: "text", group: "المرتهن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية الاتحادي رقم 5 لسنة 1985 (أحكام الرهن الحيازي)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الراهن:</b> {{pledgorName}} — الهوية/الرخصة: {{pledgorId}} — العنوان: {{pledgorAddress}}</div>
    <div class="p"><b>المرتهن (الدائن):</b> {{pledgeeName}} — الهوية/الرخصة: {{pledgeeId}} — العنوان: {{pledgeeAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="p"><b>القيمة التقديرية:</b> {{assetValue}} — <b>الحيازة:</b> {{possession}}</div>
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>لا يجوز للمرتهن استعمال المرهون أو تملّكه دون إجراءات القانون.</li>
      <li>يقع باطلاً كل اتفاق يجعل المرهون ملكاً للمرتهن عند عدم الوفاء بالدين.</li>
    </ol>
  </div>
...
export const PLEDGE_AE_EN: ContractTemplate = {
  id: 5702,
  slug: "ae-pledge-en",
  title: "Possessory Pledge Agreement (UAE) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "AE",
  fields: [
    ...
    { key: "pledgorId", label: "Pledgor ID / Licence", required: true, type: "text", group: "Pledgor" },
    ...
    { key: "pledgeeId", label: "Pledgee ID / Licence", required: true, type: "text", group: "Pledgee" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the UAE Civil Transactions Law No. 5 of 1985 (possessory pledge).</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Pledgor:</b> {{pledgorName}} — ID/Licence: {{pledgorId}} — {{pledgorAddress}}</div>
    <div><b>Pledgee (Creditor):</b> {{pledgeeName}} — ID/Licence: {{pledgeeId}} — {{pledgeeAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Pledged Asset & Possession</h3><div class="box">
    ...
    <div class="muted">A possessory pledge is perfected only by delivering the asset to the Pledgee or an agreed custodian; it is retained as security for the debt and its accessories.</div>
  </div></div>

  <div class="sec"><h3>4. Obligations</h3><div class="box">
    <div class="muted">The Pledgee/custodian shall preserve the asset with reasonable care and return it upon full payment. Any clause vesting ownership of the asset in the Pledgee upon default is void.</div>
  </div></div>
