// lib/contracts/doc-styles.ts
// أنماط CSS مشتركة لقوالب العقود عبر كل الاختصاصات (تُحقن داخل html كل قالب).
// المصدر الوحيد للأنماط؛ تعيد eg/_shared.ts وae/_shared.ts تصديرها.
