// lib/contracts/om/loan.ts
// عقد قرض وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام القرض.
// ملاحظة: تُراعى في احتساب الفوائد الحدود التي يقرّرها قانون التجارة رقم 55/90 وتعليمات البنك المركزي العُماني.
...
export const LOAN_OM_AR: ContractTemplate = {
  id: 17901,
  slug: "om-loan-ar",
  title: "عقد قرض (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "interestRate", label: "سعر الفائدة السنوي (إن وجدت)", required: false, type: "text", group: "الفائدة والسداد", placeholder: "مثال: وفق الحد الأقصى المقرّر من البنك المركزي العُماني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام القرض</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يقرّ المُقترِض باستلام مبلغ القرض من المُقرِض على الوجه المبيّن أعلاه، ويلتزم بردّ مثله جنساً وقدراً وصفةً في ميعاد الاستحقاق، عملاً بأحكام القرض في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا اتُّفق على فائدة وجب ألا تجاوز الحد الأقصى الذي يقرّره قانون التجارة رقم 55/90 وتعليمات البنك المركزي العُماني، وكل ما جاوز الحد المسموح يُخفَّض إليه.</div>
  </div>
...
export const LOAN_OM_EN: ContractTemplate = {
  id: 17902,
  slug: "om-loan-en",
  title: "Loan Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "interestRate", label: "Annual Interest Rate (if any)", required: false, type: "text", group: "Interest & Repayment", placeholder: "e.g. within the CBO maximum rate" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Loan provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Lender:</b> {{lenderName}} — Civil ID/CR: {{lenderId}} — {{lenderAddress}}</div>
    <div><b>Borrower:</b> {{borrowerName}} — Civil ID/CR: {{borrowerId}} — {{borrowerAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>2. Loan Amount & Disbursement</h3><div class="box">
    ...
    <div class="muted">The Borrower acknowledges receipt and undertakes to repay the like in kind, quantity and quality at maturity under the Civil Transactions Law.</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Interest & Repayment</h3><div class="box">
    ...
    <div class="muted">Where interest is agreed, it may not exceed the maximum set by the Commercial Law (Royal Decree No. 55/90) and the Central Bank of Oman; any excess is reduced to the permitted limit.</div>
  </div></div>
