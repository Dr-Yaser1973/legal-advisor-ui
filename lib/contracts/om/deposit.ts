// lib/contracts/om/deposit.ts
// عقد وديعة وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الوديعة.
...
export const DEPOSIT_OM_AR: ContractTemplate = {
  id: 18001,
  slug: "om-deposit-ar",
  title: "عقد وديعة (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "depositorId", label: "الرقم المدني/السجل للمودِع", required: true, type: "text", group: "المودِع" },
    ...
    { key: "custodianId", label: "الرقم المدني/السجل للمودَع لديه", required: true, type: "text", group: "المودَع لديه" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الوديعة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المودِع:</b> {{depositorName}} — الرقم المدني/السجل: {{depositorId}} — العنوان: {{depositorAddress}}</div>
    <div class="p"><b>المودَع لديه:</b> {{custodianName}} — الرقم المدني/السجل: {{custodianId}} — العنوان: {{custodianAddress}}</div>
  </div>
...
export const DEPOSIT_OM_EN: ContractTemplate = {
  id: 18002,
  slug: "om-deposit-en",
  title: "Deposit / Bailment Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "depositorId", label: "Depositor Civil ID / CR", required: true, type: "text", group: "Depositor" },
    ...
    { key: "custodianId", label: "Depositary Civil ID / CR", required: true, type: "text", group: "Depositary" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Deposit provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Depositor:</b> {{depositorName}} — Civil ID/CR: {{depositorId}} — {{depositorAddress}}</div>
    <div><b>Depositary:</b> {{custodianName}} — Civil ID/CR: {{custodianId}} — {{custodianAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Depositary's Duties</h3><div class="box">
    <div class="muted">The depositary shall keep the item with the care of an ordinary person (a higher standard applying where the deposit is for a fee), may not use or sub-deposit it without consent, and shall return it in its then-current condition together with any fruits collected.</div>
  </div></div>
