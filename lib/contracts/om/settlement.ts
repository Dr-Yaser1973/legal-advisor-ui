// lib/contracts/om/settlement.ts
// عقد صلح وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الصلح.
...
export const SETTLEMENT_OM_AR: ContractTemplate = {
  id: 18101,
  slug: "om-settlement-ar",
  title: "عقد صلح (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "party1Id", label: "الرقم المدني/السجل للطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "الرقم المدني/السجل للطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الصلح</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الطرف الأول:</b> {{party1Name}} — الرقم المدني/السجل: {{party1Id}} — العنوان: {{party1Address}}</div>
    <div class="p"><b>الطرف الثاني:</b> {{party2Name}} — الرقم المدني/السجل: {{party2Id}} — العنوان: {{party2Address}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="p">تنقضي بالصلح الحقوق والادّعاءات التي نزل عنها كلٌّ من الطرفين نهائياً، ويحسم الصلح النزاع فيما تناوله من مسائل، ولا يجوز نقضه إلا للأسباب التي يقرّرها القانون. وللطرفين توثيق الصلح أو المصادقة عليه قضائياً ليكون سنداً تنفيذياً.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>تختص المحكمة المختصة في <b>{{disputeCity}}</b> بنظر أي نزاع ينشأ عن تفسير أو تنفيذ هذا الصلح.</li>
    </ol>
  </div>
...
export const SETTLEMENT_OM_EN: ContractTemplate = {
  id: 18102,
  slug: "om-settlement-en",
  title: "Settlement Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "party1Id", label: "Party 1 Civil ID / CR", required: true, type: "text", group: "Party 1" },
    ...
    { key: "party2Id", label: "Party 2 Civil ID / CR", required: true, type: "text", group: "Party 2" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Compromise/Settlement provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Party 1:</b> {{party1Name}} — Civil ID/CR: {{party1Id}} — {{party1Address}}</div>
    <div><b>Party 2:</b> {{party2Name}} — Civil ID/CR: {{party2Id}} — {{party2Address}}</div>
  </div></div>
  ...
  <div class="sec"><h3>2. The Dispute</h3><div class="box">
    ...
    <div class="muted">A settlement is a contract by which the parties end an existing dispute or prevent a potential one through reciprocal concessions, under the Civil Transactions Law.</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Effect</h3><div class="box">
    <div class="muted">The rights waived by each party are extinguished definitively; the settlement conclusively resolves the matters it covers and may not be rescinded except on grounds fixed by law. The parties may have it notarised or judicially ratified so that it becomes an enforceable instrument.</div>
  </div></div>
