// lib/contracts/om/services.ts
// عقود الخدمات العُمانية (استشارة، تدريب، تسويق، تطوير برمجي، خدمات إلكترونية، ترخيص، إدارة).
// تخضع للقواعد العامة للعقود في قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013)
// — القوة الملزمة للعقد وتنفيذه بحسن النية — مع مراعاة الأنظمة الخاصة: قانون حق المؤلف والحقوق المجاورة
// رقم 65/2008، قانون المعاملات الإلكترونية رقم 69/2008، قانون حماية البيانات الشخصية رقم 6/2022،
// قانون حماية المستهلك رقم 66/2014.
...
function buildServiceContract(s: ServiceSpec): {
  ...
  const arFields: ContractField[] = [
    ...
    { key: "providerId", label: "الرقم المدني/السجل التجاري", required: true, type: "text", group: s.providerAr },
    ...
    { key: "clientId", label: "الرقم المدني/السجل التجاري", required: true, type: "text", group: s.clientAr },
  ...
  <div class="box">
    ...
    <div class="clause">تخضع حقوق المؤلف والحقوق المجاورة والمصنفات (ومنها البرمجيات) لأحكام قانون حق المؤلف والحقوق المجاورة العُماني رقم 65/2008؛ ولا يجوز لأي طرف استعمال علامات أو مصنفات الطرف الآخر خارج حدود هذا العقد.</div>
  </div>`
    : "";
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="p"><b>${s.providerAr}:</b> {{providerName}} — الرقم المدني/السجل: {{providerId}} — العنوان: {{providerAddress}}</div>
    <div class="p"><b>${s.clientAr}:</b> {{clientName}} — الرقم المدني/السجل: {{clientId}} — العنوان: {{clientAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">العقد ملزم للطرفين فلا يجوز نقضه ولا تعديله إلا باتفاقهما أو للأسباب التي يقرّرها القانون، ويجب تنفيذه بما يتفق مع حسن النية، عملاً بأحكام قانون المعاملات المدنية العُماني.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="p">يجوز لأي طرف إنهاء العقد بإشعار كتابي مسبق، مع سداد مقابل ما أُنجز فعلاً حتى تاريخ الإنهاء، ودون إخلال بالتعويض عن الإنهاء غير المبرَّر.</div>
  </div>
${arIpBlock}
  <div class="box">
  ...
  const enFields: ContractField[] = [
    ...
    { key: "contractCity", label: "Place of Execution", required: true, type: "text", group: "Contract Info", placeholder: "Muscat" },
  ...
  <div class="sec"><h3>5. Intellectual Property</h3><div class="box">
    <div>{{ipOwnership}}</div>
    <div class="muted">Copyright, neighbouring rights and works (including software) are subject to the Omani Copyright and Neighbouring Rights Law (Royal Decree No. 65/2008); neither party may use the other's marks or works beyond this contract.</div>
  </div></div>`
    : "";
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="sec"><h3>2. Scope & Deliverables</h3><div class="box">
    ...
    <div class="muted">This Agreement is binding on the Parties and may be amended or rescinded only by mutual consent or on grounds provided by law, and must be performed in good faith under the Civil Transactions Law.</div>
  </div></div>
...
const GENERAL_LAW_AR =
  "مصاغ وفق القواعد العامة للعقود في قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013)";
const GENERAL_LAW_EN =
  "Governed by the general contract rules of the Omani Civil Transactions Law (Royal Decree No. 29/2013)";

const consultancy = buildServiceContract({
  idBase: 18300, slug: "consultancy",
...
const marketing = buildServiceContract({
  ...
  lawNoteAr:
    "مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013)، ومع مراعاة قانون حماية المستهلك رقم 66/2014",
  lawNoteEn:
    "Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013), with regard to the Consumer Protection Law (Royal Decree No. 66/2014)",
  withIp: true,
});

const software = buildServiceContract({
  idBase: 18600, slug: "software-development",
  ...
  lawNoteAr:
    "مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013)، ومع مراعاة قانون حق المؤلف والحقوق المجاورة رقم 65/2008",
  lawNoteEn:
    "Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013), with regard to the Copyright and Neighbouring Rights Law (Royal Decree No. 65/2008)",
  withIp: true,
});

const eservices = buildServiceContract({
  idBase: 18700, slug: "e-services",
  ...
  lawNoteAr:
    "مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013)، ومع مراعاة قانون المعاملات الإلكترونية رقم 69/2008 وقانون حماية البيانات الشخصية رقم 6/2022",
  lawNoteEn:
    "Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013), with regard to the Electronic Transactions Law (Royal Decree No. 69/2008) and the Personal Data Protection Law (Royal Decree No. 6/2022)",
  withIp: true,
});

const licensing = buildServiceContract({
  idBase: 18800, slug: "licensing",
