// lib/contracts/om/partnership.ts
// عقد شركة/شراكة وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الشركة،
// وللشركات التجارية يُراعى قانون الشركات التجارية الصادر بالمرسوم السلطاني رقم 18/2019.
...
export const PARTNERSHIP_OM_AR: ContractTemplate = {
  id: 17501,
  slug: "om-partnership-ar",
  title: "عقد شراكة (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "partner1Id", label: "الرقم المدني للشريك الأول", required: true, type: "text", group: "الشركاء" },
    ...
    { key: "partner2Id", label: "الرقم المدني للشريك الثاني", required: true, type: "text", group: "الشركاء" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الشركة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الشريك الأول:</b> {{partner1Name}} — الرقم المدني: {{partner1Id}} — العنوان: {{partner1Address}}</div>
    <div class="p"><b>الشريك الثاني:</b> {{partner2Name}} — الرقم المدني: {{partner2Id}} — العنوان: {{partner2Address}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يكون له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يقع باطلاً كل اتفاق يحرم شريكاً من الربح أو يعفيه من كل خسارة (شرط الأسد).</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام قانون الشركات التجارية رقم 18/2019 إن كانت الشركة تجارية، مع استكمال إجراءات التأسيس والقيد لدى وزارة التجارة والصناعة وترويج الاستثمار).</li>
...
export const PARTNERSHIP_OM_EN: ContractTemplate = {
  id: 17502,
  slug: "om-partnership-en",
  title: "Partnership Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "partner1Id", label: "Partner 1 Civil ID", required: true, type: "text", group: "Partners" },
    ...
    { key: "partner2Id", label: "Partner 2 Civil ID", required: true, type: "text", group: "Partners" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013); the Commercial Companies Law applies to commercial companies.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Partners</h3>
    <div><b>Partner 1:</b> {{partner1Name}} — Civil ID: {{partner1Id}} — {{partner1Address}}</div>
    <div><b>Partner 2:</b> {{partner2Name}} — Civil ID: {{partner2Id}} — {{partner2Address}}</div>
  ...
  <div class="sec"><h3>3. Capital & Contributions</h3><div class="box">
    ...
    <div class="muted">A contribution of work earns a share of profit per the agreement but does not form part of the capital.</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Profit, Loss & Management</h3><div class="box">
    ...
    <div class="muted">Any clause excluding a partner from profit or from all loss is void (leonine clause).</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Where the entity is a commercial company, the Commercial Companies Law (Royal Decree No. 18/2019) applies and the incorporation and registration formalities are completed with the Ministry of Commerce, Industry and Investment Promotion.</div>
  </div></div>
