// lib/contracts/om/lease.ts
// عقد إيجار وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الإيجار،
// مع مراعاة قانون تنظيم إيجار المساكن والمحلات التجارية رقم 6/89 فيما يخضع له.
...
export const LEASE_OM_AR: ContractTemplate = {
  id: 17201,
  slug: "om-lease-ar",
  title: "عقد إيجار (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "governingLaw", label: "القانون الواجب التطبيق", required: true, type: "text", group: "أحكام إضافية", placeholder: OM.governingLawAr },
    { key: "disputeCity", label: "الاختصاص المكاني (المحكمة)", required: true, type: "text", group: "أحكام إضافية", placeholder: OM.defaultCourtCityAr },
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم المستأجر باستعمال المأجور فيما أُعدّ له وبما لا يخالف الغرض المتفق عليه، وأن يبذل في المحافظة عليه عناية الشخص المعتاد، عملاً بأحكام الإيجار في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>ينتهي الإيجار بانقضاء مدّته، مع مراعاة أحكام قانون تنظيم إيجار المساكن والمحلات التجارية رقم 6/89 واختصاص لجنة فض المنازعات الإيجارية فيما يخضع له.</li>
...
export const LEASE_OM_EN: ContractTemplate = {
  id: 17202,
  slug: "om-lease-en",
  title: "Lease Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013), Lease provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>4. Maintenance & Termination</h3><div class="box">
    <div class="muted">
      ...
      (d) On expiry, the Lessee returns the premises in their received condition, subject to fair wear and tear; the Law Regulating the Lease of Dwellings and Commercial Premises (No. 6/89) and the Rent Disputes Committee apply to leases within their scope.
    </div>
  </div></div>
  ...
  <div class="sec"><h3>5. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the Sultanate of Oman apply and the competent court in {{contractCity}} has jurisdiction.</div>
  </div></div>
