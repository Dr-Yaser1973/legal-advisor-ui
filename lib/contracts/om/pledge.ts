// lib/contracts/om/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الرهن الحيازي.
// وللرهن التجاري على المنقولات يُراعى قانون التجارة الصادر بالمرسوم السلطاني رقم 55/90.
...
export const PLEDGE_OM_AR: ContractTemplate = {
  id: 17701,
  slug: "om-pledge-ar",
  title: "عقد رهن حيازي (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "pledgorId", label: "الرقم المدني/السجل للراهن", required: true, type: "text", group: "الراهن" },
    ...
    { key: "pledgeeId", label: "الرقم المدني/السجل للمرتهن", required: true, type: "text", group: "المرتهن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الرهن الحيازي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الراهن:</b> {{pledgorName}} — الرقم المدني/السجل: {{pledgorId}} — العنوان: {{pledgorAddress}}</div>
    <div class="p"><b>المرتهن (الدائن):</b> {{pledgeeName}} — الرقم المدني/السجل: {{pledgeeId}} — العنوان: {{pledgeeAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>للراهن ثمار المرهون ونماؤه ما لم يُتفق على أن تُخصم من الدين. ولا يجوز للمرتهن استعمال المرهون أو الانتفاع به دون إذن.</li>
      <li>يقع باطلاً كل اتفاق يجعل المرهون ملكاً للمرتهن عند عدم الوفاء، أو يبيح له بيعه دون مراعاة الإجراءات التي قرّرها القانون.</li>
    </ol>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (وللرهن التجاري على المنقولات تُراعى أحكام قانون التجارة رقم 55/90).</li>
...
export const PLEDGE_OM_EN: ContractTemplate = {
  id: 17702,
  slug: "om-pledge-en",
  title: "Possessory Pledge Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "pledgorId", label: "Pledgor Civil ID / CR", required: true, type: "text", group: "Pledgor" },
    ...
    { key: "pledgeeId", label: "Pledgee Civil ID / CR", required: true, type: "text", group: "Pledgee" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Possessory Pledge provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Pledgor:</b> {{pledgorName}} — Civil ID/CR: {{pledgorId}} — {{pledgorAddress}}</div>
    <div><b>Pledgee (Creditor):</b> {{pledgeeName}} — Civil ID/CR: {{pledgeeId}} — {{pledgeeAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Pledged Asset & Possession</h3><div class="box">
    ...
    <div class="muted">A possessory pledge is perfected only by delivering the asset to the Pledgee or an agreed custodian; it is held as security for the debt and its accessories under the Civil Transactions Law.</div>
  </div></div>

  <div class="sec"><h3>4. Obligations</h3><div class="box">
    <div class="muted">The Pledgee (or custodian) shall preserve the asset with the care of an ordinary person and return it upon full payment. Any clause vesting ownership of the pledged asset in the Pledgee upon default — or allowing its sale outside the statutory procedure — is void.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">A commercial pledge over movable assets is additionally subject to the Commercial Law (Royal Decree No. 55/90).</div>
  </div></div>
