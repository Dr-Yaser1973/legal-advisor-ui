// lib/contracts/om/construction.ts
// عقد مقاولة وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام المقاولة،
// والضمان العشري للمباني والمنشآت الثابتة (المادة 634: مسؤولية المقاول والمهندس المتضامنة عشر سنوات).
...
export const CONSTRUCTION_OM_AR: ContractTemplate = {
  id: 17401,
  slug: "om-construction-ar",
  title: "عقد مقاولة (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "ownerId", label: "الرقم المدني/السجل لرب العمل", required: true, type: "text", group: "رب العمل" },
    ...
    { key: "contractorId", label: "السجل التجاري/الرقم المدني للمقاول", required: true, type: "text", group: "المقاول" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام المقاولة والضمان العشري</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">رب العمل</td><td><b>الاسم:</b> {{ownerName}} — <b>الرقم المدني/السجل:</b> {{ownerId}} — <b>العنوان:</b> {{ownerAddress}}</td></tr>
      <tr><td class="th">المقاول</td><td><b>الاسم:</b> {{contractorName}} — <b>الرقم المدني/السجل:</b> {{contractorId}} — <b>العنوان:</b> {{contractorAddress}}</td></tr>
    </table>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا تعهّد المقاول بتقديم مادة العمل كلها أو بعضها كان مسؤولاً عن جودتها ويضمنها لرب العمل، عملاً بأحكام المقاولة في قانون المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">في المقاولة بأجر إجمالي (مقطوع) على أساس تصميم متفق عليه لا يجوز للمقاول المطالبة بزيادة الأجر بسبب ارتفاع الأسعار أو تغيّر التكاليف، إلا في الحدود التي يقرّرها القانون.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>في مقاولات المباني والمنشآت الثابتة يضمن المقاول والمهندس متضامنين ما يقع خلال عشر سنوات من تهدّم كلي أو جزئي أو عيب يهدّد متانة البناء وسلامته، ما لم يتضمن العقد مدة أطول (الضمان العشري — المادة 634 من قانون المعاملات المدنية العُماني).</li>
    </ol>
  </div>
...
export const CONSTRUCTION_OM_EN: ContractTemplate = {
  id: 17402,
  slug: "om-construction-en",
  title: "Construction / Works Contract (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "ownerId", label: "Owner Civil ID / CR", required: true, type: "text", group: "Owner" },
    ...
    { key: "contractorId", label: "Contractor CR / Civil ID", required: true, type: "text", group: "Contractor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Muqawala; decennial liability, Art. 634.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Owner:</b> {{ownerName}}<br/><b>Civil ID/CR:</b> {{ownerId}}<br/><b>Address:</b> {{ownerAddress}}</div>
      <div><b>Contractor:</b> {{contractorName}}<br/><b>Civil ID/CR:</b> {{contractorId}}<br/><b>Address:</b> {{contractorAddress}}</div>
    </div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty & Liability</h3><div class="box">
    ...
    <div class="muted">For buildings and fixed structures, the Contractor and the engineer are jointly liable for total or partial collapse and for defects threatening the building's stability and safety for ten years from delivery, unless a longer period is agreed (decennial liability, Art. 634 Omani Civil Transactions Law).</div>
  </div></div>
