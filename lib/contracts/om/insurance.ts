// lib/contracts/om/insurance.ts
// عقد (وثيقة) تأمين وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) (القواعد العامة)،
// وتحت إشراف الهيئة العامة لسوق المال المنظِّمة لقطاع التأمين (قانون شركات التأمين رقم 12/79).
...
export const INSURANCE_OM_AR: ContractTemplate = {
  id: 18201,
  slug: "om-insurance-ar",
  title: "عقد (وثيقة) تأمين (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإصدار", required: true, type: "text", group: "معلومات الوثيقة", placeholder: "مسقط" },

    { key: "insurerName", label: "اسم شركة التأمين (المؤمِّن)", required: true, type: "text", group: "المؤمِّن" },
    { key: "insurerLicense", label: "رقم ترخيص الهيئة العامة لسوق المال/السجل التجاري", required: true, type: "text", group: "المؤمِّن" },
    ...
    { key: "insuredId", label: "الرقم المدني/السجل للمؤمَّن له", required: true, type: "text", group: "المؤمَّن له" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) وتحت إشراف الهيئة العامة لسوق المال</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المؤمَّن له:</b> {{insuredName}} — الرقم المدني/السجل: {{insuredId}} — العنوان: {{insuredAddress}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">التأمين عقد يلتزم المؤمِّن بمقتضاه أن يؤدّي إلى المؤمَّن له أو المستفيد مبلغاً من المال أو إيراداً أو أي عوض مالي آخر عند تحقّق الخطر المؤمَّن منه، مقابل قسط يؤدّيه المؤمَّن له، ويصدر عن شركة مرخّصة تحت إشراف الهيئة العامة لسوق المال.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> وأحكام قانون شركات التأمين رقم 12/79 ولوائح الهيئة العامة لسوق المال.</li>
...
export const INSURANCE_OM_EN: ContractTemplate = {
  id: 18202,
  slug: "om-insurance-en",
  title: "Insurance Policy / Contract (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "contractCity", label: "Place of Issue", required: true, type: "text", group: "Policy Info", placeholder: "Muscat" },

    { key: "insurerName", label: "Insurer (Company) Name", required: true, type: "text", group: "Insurer" },
    { key: "insurerLicense", label: "FSA Licence / CR", required: true, type: "text", group: "Insurer" },
    ...
    { key: "insuredId", label: "Insured Civil ID / CR", required: true, type: "text", group: "Insured" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) and supervised by the Financial Services Authority.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    ...
    <div><b>Insured:</b> {{insuredName}} — Civil ID/CR: {{insuredId}} — {{insuredAddress}}</div>
  ...
  <div class="sec"><h3>2. Subject & Cover</h3><div class="box">
    ...
    <div class="muted">Insurance is a contract whereby the insurer, against a premium, undertakes to pay the insured or beneficiary a sum or benefit on the occurrence of the insured event; cover is written by a company licensed and supervised by the Financial Services Authority.</div>
  </div></div>
