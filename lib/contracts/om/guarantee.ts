// lib/contracts/om/guarantee.ts
// عقد كفالة وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الكفالة.
...
export const GUARANTEE_OM_AR: ContractTemplate = {
  id: 17801,
  slug: "om-guarantee-ar",
  title: "عقد كفالة (عُمان) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "creditorId", label: "الرقم المدني/السجل للدائن", required: true, type: "text", group: "الدائن" },
    ...
    { key: "debtorId", label: "الرقم المدني/السجل للمدين", required: true, type: "text", group: "المدين الأصلي" },
    ...
    { key: "guarantorId", label: "الرقم المدني/السجل للكفيل", required: true, type: "text", group: "الكفيل" },
    ...
    { key: "guaranteeScope", label: "نطاق الكفالة", required: true, type: "select", group: "محل الكفالة",
      options: ["أصل الدين وملحقاته (الفوائد والمصروفات)", "أصل الدين فقط"] },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون المعاملات المدنية العُماني (المرسوم السلطاني رقم 29/2013) — أحكام الكفالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الدائن:</b> {{creditorName}} — الرقم المدني/السجل: {{creditorId}} — العنوان: {{creditorAddress}}</div>
    <div class="p"><b>المدين الأصلي:</b> {{debtorName}} — الرقم المدني/السجل: {{debtorId}} — العنوان: {{debtorAddress}}</div>
    <div class="p"><b>الكفيل:</b> {{guarantorName}} — الرقم المدني/السجل: {{guarantorId}} — العنوان: {{guarantorAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يكفل الكفيل تنفيذ التزام المدين إذا لم يفِ به المدين نفسه، ولا تصحّ الكفالة إلا إذا كان الالتزام المكفول صحيحاً، عملاً بأحكام الكفالة في قانون المعاملات المدنية.</div>
  </div>
...
export const GUARANTEE_OM_EN: ContractTemplate = {
  id: 17802,
  slug: "om-guarantee-en",
  title: "Suretyship / Guarantee (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "creditorId", label: "Creditor Civil ID / CR", required: true, type: "text", group: "Creditor" },
    ...
    { key: "debtorId", label: "Debtor Civil ID / CR", required: true, type: "text", group: "Principal Debtor" },
    ...
    { key: "guarantorId", label: "Guarantor Civil ID / CR", required: true, type: "text", group: "Guarantor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Civil Transactions Law (Royal Decree No. 29/2013) — Suretyship provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Creditor:</b> {{creditorName}} — Civil ID/CR: {{creditorId}} — {{creditorAddress}}</div>
    <div><b>Principal Debtor:</b> {{debtorName}} — Civil ID/CR: {{debtorId}} — {{debtorAddress}}</div>
    <div><b>Guarantor:</b> {{guarantorName}} — Civil ID/CR: {{guarantorId}} — {{guarantorAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Effect</h3><div class="box">
    <div class="muted">
      (a) In an ordinary guarantee the surety is not pursued until the principal debtor is pursued and their assets discussed (benefit of discussion).<br/>
      (b) In a joint & several guarantee the creditor may claim against the surety directly.<br/>
