// lib/contracts/om/employment.ts
// عقد عمل وفق قانون العمل العُماني الصادر بالمرسوم السلطاني رقم 53/2023.
// فترة التجربة لا تجاوز ثلاثة أشهر لمن يتقاضى أجره شهرياً وشهرين لغيرهم، ولمرة واحدة لدى صاحب العمل نفسه،
// وإشعار الإنهاء لا يقلّ عن شهر (وأثناء التجربة إشعار سبعة أيام).
...
const OM_LABOUR_AR = "قانون العمل العُماني الصادر بالمرسوم السلطاني رقم 53/2023";
const OM_LABOUR_EN = "Omani Labour Law (Royal Decree No. 53/2023)";

export const EMPLOYMENT_OM_AR: ContractTemplate = {
  id: 17301,
  slug: "om-employment-ar",
  title: "عقد عمل (عُمان) — عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "contractCity", label: "مكان الإبرام", required: true, type: "text", group: "معلومات العقد", placeholder: "مسقط" },
    ...
    { key: "workingHours", label: "ساعات العمل", required: true, type: "text", group: "ساعات العمل والإجازات", placeholder: "مثال: 8 ساعات يومياً / 45 ساعة أسبوعياً" },
    ...
    { key: "governingLaw", label: "القانون الحاكم", required: false, type: "text", group: "أحكام", placeholder: OM_LABOUR_AR },
    { key: "disputeCity", label: "الاختصاص القضائي", required: false, type: "text", group: "أحكام", placeholder: OM.defaultCourtCityAr },
  ],
  html: `
<div class="doc rtl">
  <div class="header">
    <div class="title">عقد عمل</div>
    <div class="subtitle">مصاغ وفق قانون العمل العُماني الصادر بالمرسوم السلطاني رقم 53/2023</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم صاحب العمل بأداء الأجر عبر نظام حماية الأجور، وبتسجيل العامل العُماني لدى صندوق الحماية الاجتماعية وفق النظام المعمول به.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">لا تجاوز فترة التجربة ثلاثة أشهر لمن يتقاضى أجره شهرياً وشهرين لغيرهم، ولا يجوز وضع العامل تحت التجربة أكثر من مرة لدى صاحب العمل نفسه. ولصاحب العمل إنهاء العقد أثناءها بإشعار كتابي مدته سبعة أيام إذا تبيّن عدم صلاحية العامل، وتُحتسب التجربة ضمن مدة الخدمة إذا اجتازها العامل.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>لأي من الطرفين إنهاء العقد بإشعار كتابي مسبق لا تقل مدته عن شهر، مع أداء أجر مدة الإشعار عند عدم مراعاته.</li>
      <li>يترتب على الإنهاء لسبب غير مشروع تعويض العامل وفق القانون، ويستحق العامل مكافأة نهاية الخدمة عن مدة خدمته (أو حقوقه لدى صندوق الحماية الاجتماعية) وشهادة خبرة.</li>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>تختص المحكمة المختصة في <b>{{disputeCity}}</b> بنظر أي نزاع ينشأ عن هذا العقد بعد إحالته من الجهة المختصة.</li>
...
export const EMPLOYMENT_OM_EN: ContractTemplate = {
  id: 17302,
  slug: "om-employment-en",
  title: "Employment Agreement (Oman) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "OM",
  fields: [
    ...
    { key: "workingHours", label: "Working Hours", required: true, type: "text", group: "Hours & Leave", placeholder: "e.g. 8 hrs/day, 45 hrs/week" },
    ...
    { key: "governingLaw", label: "Governing Law", required: false, type: "text", group: "Provisions", placeholder: OM_LABOUR_EN },
    { key: "disputeCity", label: "Jurisdiction", required: false, type: "text", group: "Provisions", placeholder: OM.defaultCourtCityEn },
  ],
  html: `
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Omani Labour Law (Royal Decree No. 53/2023).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>3. Pay</h3><div class="box">
    ...
    <div class="muted">Wages are paid through the Wage Protection System; Omani employees are registered with the Social Protection Fund under the applicable law.</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Term & Probation</h3><div class="box">
    ...
    <div class="muted">Probation may not exceed three months for monthly-paid employees and two months for others, and may be applied only once with the same employer. During it the employer may terminate on seven days' written notice if the employee is found unsuitable; if the employee passes, probation counts toward service.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Termination</h3><div class="box">
    <div class="muted">
      (a) Either party may terminate on prior written notice of not less than one month; a party who does not observe the notice pays the wage for its period.<br/>
      (b) Termination for an invalid reason gives rise to compensation, and the Employee is entitled to an end-of-service benefit (or Social Protection Fund rights) and an experience certificate.<br/>
