// lib/contracts/sa/deposit.ts
// عقد وديعة وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الوديعة.
...
export const DEPOSIT_SA_AR: ContractTemplate = {
  id: 12001,
  slug: "sa-deposit-ar",
  title: "عقد وديعة (السعودية) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "depositorId", label: "رقم الهوية/السجل للمودِع", required: true, type: "text", group: "المودِع" },
    ...
    { key: "custodianId", label: "رقم الهوية/السجل للمودَع لديه", required: true, type: "text", group: "المودَع لديه" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الوديعة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">تُنقَل بالوديعة حيازة الشيء إلى المودَع لديه ليتولّى حفظه على أن يردّه عيناً عند طلب المودِع، عملاً بأحكام الوديعة في نظام المعاملات المدنية.</div>
  </div>
...
export const DEPOSIT_SA_EN: ContractTemplate = {
  id: 12002,
  slug: "sa-deposit-en",
  title: "Deposit / Bailment Agreement (Saudi Arabia) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "depositorId", label: "Depositor ID / CR", required: true, type: "text", group: "Depositor" },
    ...
    { key: "custodianId", label: "Depositary ID / CR", required: true, type: "text", group: "Depositary" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Saudi Civil Transactions Law (M/191 of 1444H) — Deposit provisions.</div>
    </div>
    <div class="meta">
