// lib/contracts/sa/settlement.ts
// عقد صلح وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الصلح.
...
export const SETTLEMENT_SA_AR: ContractTemplate = {
  id: 12101,
  slug: "sa-settlement-ar",
  title: "عقد صلح (السعودية) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "party1Id", label: "رقم الهوية/السجل للطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "رقم الهوية/السجل للطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الصلح</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الطرف الأول:</b> {{party1Name}} — الهوية/السجل: {{party1Id}} — العنوان: {{party1Address}}</div>
    <div class="p"><b>الطرف الثاني:</b> {{party2Name}} — الهوية/السجل: {{party2Id}} — العنوان: {{party2Address}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في نظام المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="p">تنقضي بالصلح الحقوق والادّعاءات التي نزل عنها كلٌّ من الطرفين نهائياً، ويحسم الصلح النزاع فيما تناوله من مسائل، ولا يجوز نقضه إلا للأسباب التي يقرّرها النظام. وللطرفين توثيق الصلح لدى الجهة المختصة أو المصادقة عليه قضائياً ليكون سنداً تنفيذياً.</div>
  </div>
...
export const SETTLEMENT_SA_EN: ContractTemplate = {
  id: 12102,
  slug: "sa-settlement-en",
  title: "Settlement Agreement (Saudi Arabia) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "party1Id", label: "Party 1 ID / CR", required: true, type: "text", group: "Party 1" },
    ...
    { key: "party2Id", label: "Party 2 ID / CR", required: true, type: "text", group: "Party 2" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Saudi Civil Transactions Law (M/191 of 1444H) — Compromise/Settlement provisions.</div>
    </div>
    <div class="meta">
