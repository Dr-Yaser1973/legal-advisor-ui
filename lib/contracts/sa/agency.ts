// lib/contracts/sa/agency.ts
// عقد وكالة وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الوكالة،
// ولوكالات التوزيع والاستيراد التجارية يُراعى نظام الوكالات التجارية السعودي.
...
export const AGENCY_SA_AR: ContractTemplate = {
  id: 11601,
  slug: "sa-agency-ar",
  title: "عقد وكالة (السعودية) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "principalId", label: "رقم الهوية/السجل للموكِّل", required: true, type: "text", group: "الموكِّل" },
    ...
    { key: "agentId", label: "رقم الهوية/السجل للوكيل", required: true, type: "text", group: "الوكيل" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الوكالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الموكِّل:</b> {{principalName}} — الهوية/السجل: {{principalId}} — العنوان: {{principalAddress}}</div>
    <div class="p"><b>الوكيل:</b> {{agentName}} — الهوية/السجل: {{agentId}} — العنوان: {{agentAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الوكالة العامة لا تخوّل الوكيل إلا أعمال الإدارة. أما البيع والرهن والتبرع والصلح والإقرار وسائر التصرفات التي تخرج عن الإدارة فلا بدّ فيها من تفويض خاص صريح، عملاً بأحكام الوكالة في نظام المعاملات المدنية.</div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (ولوكالات التوزيع والاستيراد التجارية يُراعى نظام الوكالات التجارية وقيدها لدى وزارة التجارة).</li>
...
export const AGENCY_SA_EN: ContractTemplate = {
  id: 11602,
  slug: "sa-agency-en",
  title: "Agency / Mandate Agreement (Saudi Arabia) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "principalId", label: "Principal ID / CR", required: true, type: "text", group: "Principal" },
    ...
    { key: "agentId", label: "Agent ID / CR", required: true, type: "text", group: "Agent" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Saudi Civil Transactions Law (M/191 of 1444H) — Mandate provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Commercial distribution and import agencies are additionally subject to the Commercial Agencies Law and its registration with the Ministry of Commerce.</div>
  </div></div>
