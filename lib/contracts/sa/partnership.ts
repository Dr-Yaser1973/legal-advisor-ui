// lib/contracts/sa/partnership.ts
// عقد شركة/شراكة وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الشركة،
// وللشركات التجارية يُراعى نظام الشركات السعودي (المرسوم الملكي م/132 لسنة 1443هـ، النافذ في 19 يناير 2023م).
...
export const PARTNERSHIP_SA_AR: ContractTemplate = {
  id: 11501,
  slug: "sa-partnership-ar",
  title: "عقد شراكة (السعودية) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "partner1Id", label: "رقم الهوية للشريك الأول", required: true, type: "text", group: "الشركاء" },
    ...
    { key: "partner2Id", label: "رقم الهوية للشريك الثاني", required: true, type: "text", group: "الشركاء" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق نظام المعاملات المدنية السعودي (م/191 لسنة 1444هـ) — أحكام الشركة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الشريك الأول:</b> {{partner1Name}} — الهوية: {{partner1Id}} — العنوان: {{partner1Address}}</div>
    <div class="p"><b>الشريك الثاني:</b> {{partner2Name}} — الهوية: {{partner2Id}} — العنوان: {{partner2Address}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يكون له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في نظام المعاملات المدنية.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام نظام الشركات السعودي إن كانت الشركة تجارية، مع استكمال إجراءات التأسيس والقيد لدى وزارة التجارة).</li>
...
export const PARTNERSHIP_SA_EN: ContractTemplate = {
  id: 11502,
  slug: "sa-partnership-en",
  title: "Partnership Agreement (Saudi Arabia) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Saudi Civil Transactions Law (M/191 of 1444H); the Companies Law applies to commercial companies.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Where the entity is a commercial company, the Saudi Companies Law (Royal Decree M/132 of 1443H) applies and the incorporation and registration formalities are completed with the Ministry of Commerce.</div>
  </div></div>
