// lib/contracts/sa/sale.ts
// عقد بيع منقول وفق نظام المعاملات المدنية السعودي (المرسوم الملكي م/191 لسنة 1444هـ)
...
export const SALE_SA_AR: ContractTemplate = {
  id: 11101,
  slug: "sa-sale-movable-ar",
  title: "عقد بيع منقول (السعودية) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "sellerId", label: "رقم الهوية/السجل التجاري للبائع", required: true, type: "text", group: "البائع" },
    { key: "sellerAddress", label: "عنوان البائع (العنوان الوطني)", required: true, type: "text", group: "البائع" },
    ...
    { key: "buyerId", label: "رقم الهوية/السجل التجاري للمشتري", required: true, type: "text", group: "المشتري" },
    { key: "buyerAddress", label: "عنوان المشتري (العنوان الوطني)", required: true, type: "text", group: "المشتري" },
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">البائع</td><td><b>الاسم:</b> {{sellerName}} — <b>الهوية/السجل:</b> {{sellerId}} — <b>العنوان:</b> {{sellerAddress}} — <b>الهاتف:</b> {{sellerPhone}}</td></tr>
      <tr><td class="th">المشتري</td><td><b>الاسم:</b> {{buyerName}} — <b>الهوية/السجل:</b> {{buyerId}} — <b>العنوان:</b> {{buyerAddress}} — <b>الهاتف:</b> {{buyerPhone}}</td></tr>
    </table>
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم المشتري بأداء الثمن في المكان والزمان المتفق عليهما، ويقرّ البائع باستلامه بحسب ما يثبت بالإيصالات عند الاقتضاء، ويُعدّ العقد ملزماً للطرفين فلا ينفرد أحدهما بنقضه أو تعديله إلا باتفاقهما أو بما يقرّره النظام.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>يضمن البائع خلوّ المبيع من العيوب الخفية التي تنقص من قيمته أو من الانتفاع به وفق أحكام نظام المعاملات المدنية، ما لم يُتفق على الإعفاء من الضمان في حدود ما يجيزه النظام ودون أن يعلم البائع بالعيب ويكتمه.</li>
...
export const SALE_SA_EN: ContractTemplate = {
  id: 11102,
  slug: "sa-sale-movable-en",
  title: "Movable Property Sale Agreement (Saudi Arabia) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "SA",
  fields: [
    ...
    { key: "sellerId", label: "Seller National ID/Iqama or CR", required: true, type: "text", group: "Seller" },
    { key: "sellerAddress", label: "Seller Address (National Address)", required: true, type: "text", group: "Seller" },
    ...
    { key: "buyerId", label: "Buyer National ID/Iqama or CR", required: true, type: "text", group: "Buyer" },
    { key: "buyerAddress", label: "Buyer Address (National Address)", required: true, type: "text", group: "Buyer" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Saudi Civil Transactions Law (Royal Decree No. M/191 of 1444H).</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Seller:</b> {{sellerName}}<br/><b>ID/CR:</b> {{sellerId}}<br/><b>Address:</b> {{sellerAddress}}<br/><b>Contact:</b> {{sellerPhone}}</div>
      <div><b>Buyer:</b> {{buyerName}}<br/><b>ID/CR:</b> {{buyerId}}<br/><b>Address:</b> {{buyerAddress}}<br/><b>Contact:</b> {{buyerPhone}}</div>
    </div>
  ...
  <div class="sec"><h3>6. Governing Law & Dispute Resolution</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the Kingdom of Saudi Arabia apply and the competent court in {{contractCity}} has jurisdiction unless the Parties agree in writing to arbitration.</div>
