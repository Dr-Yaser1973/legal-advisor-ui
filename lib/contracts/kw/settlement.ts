// lib/contracts/kw/settlement.ts
// عقد صلح وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الصلح.
...
export const SETTLEMENT_KW_AR: ContractTemplate = {
  id: 14101,
  slug: "kw-settlement-ar",
  title: "عقد صلح (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الصلح</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في القانون المدني الكويتي.</div>
  </div>
...
export const SETTLEMENT_KW_EN: ContractTemplate = {
  id: 14102,
  slug: "kw-settlement-en",
  title: "Settlement Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Compromise/Settlement provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Party 1:</b> {{party1Name}} — ID/CR: {{party1Id}} — {{party1Address}}</div>
    <div><b>Party 2:</b> {{party2Name}} — ID/CR: {{party2Id}} — {{party2Address}}</div>
  </div></div>
