// lib/contracts/kw/sale.ts
// عقد بيع منقول وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) —
...
export const SALE_KW_AR: ContractTemplate = {
  id: 13101,
  slug: "kw-sale-movable-ar",
  title: "عقد بيع منقول (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>يضمن البائع خلوّ المبيع من العيوب الخفية التي تنقص من قيمته أو من الانتفاع به وفق أحكام القانون المدني الكويتي، ما لم يُتفق على الإعفاء من الضمان في حدود ما يجيزه القانون ودون أن يعلم البائع بالعيب ويكتمه.</li>
...
export const SALE_KW_EN: ContractTemplate = {
  id: 13102,
  slug: "kw-sale-movable-en",
  title: "Movable Property Sale Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>6. Governing Law & Dispute Resolution</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the State of Kuwait apply and the competent court in {{contractCity}} has jurisdiction unless the Parties agree in writing to arbitration.</div>
