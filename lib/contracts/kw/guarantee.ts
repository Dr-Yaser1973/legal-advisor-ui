// lib/contracts/kw/guarantee.ts
// عقد كفالة وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الكفالة.
...
export const GUARANTEE_KW_AR: ContractTemplate = {
  id: 13801,
  slug: "kw-guarantee-ar",
  title: "عقد كفالة (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الكفالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يكفل الكفيل تنفيذ التزام المدين إذا لم يفِ به المدين نفسه، ولا تصحّ الكفالة إلا إذا كان الالتزام المكفول صحيحاً، عملاً بأحكام الكفالة في القانون المدني الكويتي.</div>
  </div>
...
export const GUARANTEE_KW_EN: ContractTemplate = {
  id: 13802,
  slug: "kw-guarantee-en",
  title: "Suretyship / Guarantee (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Suretyship provisions.</div>
    </div>
    <div class="meta">
