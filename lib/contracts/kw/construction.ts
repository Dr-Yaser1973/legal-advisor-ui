// lib/contracts/kw/construction.ts
// عقد مقاولة وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام المقاولة،
// والضمان العشري للمباني والمنشآت الثابتة (المواد 692–697: مسؤولية المقاول والمهندس المتضامنة).
...
export const CONSTRUCTION_KW_AR: ContractTemplate = {
  id: 13401,
  slug: "kw-construction-ar",
  title: "عقد مقاولة (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام المقاولة والضمان العشري</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">إذا تعهّد المقاول بتقديم مادة العمل كلها أو بعضها كان مسؤولاً عن جودتها ويضمنها لرب العمل، عملاً بأحكام المقاولة في القانون المدني الكويتي.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>في مقاولات المباني والمنشآت الثابتة يضمن المقاول والمهندس المعماري متضامنين ما يقع خلال عشر سنوات من تهدّم كلي أو جزئي أو عيب يهدّد متانة البناء وسلامته، ولو كان الخلل ناشئاً عن عيب في الأرض، ما لم يتضمن العقد مدة أطول (الضمان العشري — المواد 692–697 من القانون المدني الكويتي).</li>
    </ol>
  </div>
...
export const CONSTRUCTION_KW_EN: ContractTemplate = {
  id: 13402,
  slug: "kw-construction-en",
  title: "Construction / Works Contract (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Muqawala; decennial liability, Arts. 692–697.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>5. Warranty & Liability</h3><div class="box">
    ...
    <div class="muted">For buildings and fixed structures, the Contractor and the architect are jointly liable for total or partial collapse and for defects threatening the building's stability and safety for ten years from delivery — even where the fault stems from a defect in the ground — unless a longer period is agreed (decennial liability, Arts. 692–697 Kuwaiti Civil Code).</div>
  </div></div>
