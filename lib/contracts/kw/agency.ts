// lib/contracts/kw/agency.ts
// عقد وكالة وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الوكالة،
// ولوكالات التوزيع والاستيراد التجارية يُراعى قانون الوكالات التجارية رقم 13 لسنة 2016.
...
export const AGENCY_KW_AR: ContractTemplate = {
  id: 13601,
  slug: "kw-agency-ar",
  title: "عقد وكالة (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الوكالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الوكالة العامة لا تخوّل الوكيل إلا أعمال الإدارة. أما البيع والرهن والتبرع والصلح والإقرار وسائر التصرفات التي تخرج عن الإدارة فلا بدّ فيها من تفويض خاص صريح، عملاً بأحكام الوكالة في القانون المدني الكويتي.</div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>ينفّذ الوكيل الوكالة دون أن يتجاوز حدودها، ويبذل عناية الرجل المعتاد، ويكون مسؤولاً عن الغش وعن الخطأ الجسيم.</li>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (ولوكالات التوزيع والاستيراد التجارية يُراعى قانون الوكالات التجارية رقم 13 لسنة 2016 وقيدها لدى وزارة التجارة والصناعة).</li>
...
export const AGENCY_KW_EN: ContractTemplate = {
  id: 13602,
  slug: "kw-agency-en",
  title: "Agency / Mandate Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Mandate provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Principal:</b> {{principalName}} — ID/CR: {{principalId}} — {{principalAddress}}</div>
    <div><b>Agent:</b> {{agentName}} — ID/CR: {{agentId}} — {{agentAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Agent's Duties</h3><div class="box">
    <div class="muted">The Agent shall act within, and not exceed, the scope of the mandate, exercise the care of a reasonable person, remain liable for fraud and gross fault, render account to the Principal and hand over whatever is received on the Principal's behalf.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Commercial distribution and import agencies are additionally subject to the Commercial Agencies Law No. 13 of 2016 and its registration with the Ministry of Commerce and Industry.</div>
  </div></div>
