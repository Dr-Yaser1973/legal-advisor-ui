// lib/contracts/kw/deposit.ts
// عقد وديعة وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الوديعة.
...
export const DEPOSIT_KW_AR: ContractTemplate = {
  id: 14001,
  slug: "kw-deposit-ar",
  title: "عقد وديعة (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الوديعة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">تُنقَل بالوديعة حيازة الشيء إلى المودَع لديه ليتولّى حفظه على أن يردّه عيناً عند طلب المودِع، عملاً بأحكام الوديعة في القانون المدني الكويتي.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يبذل المودَع لديه في حفظ الوديعة عناية الرجل المعتاد، وتشتدّ عنايته إذا كانت الوديعة بأجر.</li>
...
export const DEPOSIT_KW_EN: ContractTemplate = {
  id: 14002,
  slug: "kw-deposit-en",
  title: "Deposit / Bailment Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Deposit provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Depositor:</b> {{depositorName}} — ID/CR: {{depositorId}} — {{depositorAddress}}</div>
    <div><b>Depositary:</b> {{custodianName}} — ID/CR: {{custodianId}} — {{custodianAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Depositary's Duties</h3><div class="box">
    <div class="muted">The depositary shall keep the item with the care of a reasonable person (a higher standard applying where the deposit is for a fee), may not use or sub-deposit it without consent, and shall return it in its then-current condition together with any fruits collected.</div>
  </div></div>
