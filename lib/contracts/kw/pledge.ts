// lib/contracts/kw/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الرهن الحيازي.
// وللرهن التجاري على المنقولات يُراعى قانون التجارة الكويتي رقم 68 لسنة 1980.
...
export const PLEDGE_KW_AR: ContractTemplate = {
  id: 13701,
  slug: "kw-pledge-ar",
  title: "عقد رهن حيازي (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الرهن الحيازي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في القانون المدني الكويتي.</div>
  </div>

  <div class="box">
    <div class="h">رابعاً: التزامات الطرفين</div>
    <ol class="ol">
      <li>يحافظ المرتهن (أو العدل) على المرهون بعناية الرجل المعتاد، ويردّه عند الوفاء بالدين كاملاً.</li>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (وللرهن التجاري على المنقولات تُراعى أحكام قانون التجارة رقم 68 لسنة 1980).</li>
...
export const PLEDGE_KW_EN: ContractTemplate = {
  id: 13702,
  slug: "kw-pledge-en",
  title: "Possessory Pledge Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980) — Possessory Pledge provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>4. Obligations</h3><div class="box">
    <div class="muted">The Pledgee (or custodian) shall preserve the asset with the care of a reasonable person and return it upon full payment. Any clause vesting ownership of the pledged asset in the Pledgee upon default — or allowing its sale outside the statutory procedure — is void.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">A commercial pledge over movable assets is additionally subject to the Commercial Code (Law No. 68 of 1980).</div>
  </div></div>
