// lib/contracts/kw/partnership.ts
// عقد شركة/شراكة وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الشركة،
// وللشركات التجارية يُراعى قانون الشركات الكويتي رقم 1 لسنة 2016 وتعديلاته.
...
export const PARTNERSHIP_KW_AR: ContractTemplate = {
  id: 13501,
  slug: "kw-partnership-ar",
  title: "عقد شراكة (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — أحكام الشركة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يكون له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في القانون المدني الكويتي.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام قانون الشركات الكويتي رقم 1 لسنة 2016 إن كانت الشركة تجارية، مع استكمال إجراءات التأسيس والقيد لدى وزارة التجارة والصناعة).</li>
...
export const PARTNERSHIP_KW_EN: ContractTemplate = {
  id: 13502,
  slug: "kw-partnership-en",
  title: "Partnership Agreement (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980); the Companies Law applies to commercial companies.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Where the entity is a commercial company, the Kuwaiti Companies Law No. 1 of 2016 applies and the incorporation and registration formalities are completed with the Ministry of Commerce and Industry.</div>
  </div></div>
