// lib/contracts/kw/insurance.ts
// عقد (وثيقة) تأمين وفق قانون تنظيم التأمين الكويتي رقم 125 لسنة 2019 (وحدة تنظيم التأمين)،
// مع القواعد العامة للعقود في القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980).
...
export const INSURANCE_KW_AR: ContractTemplate = {
  id: 14201,
  slug: "kw-insurance-ar",
  title: "عقد (وثيقة) تأمين (الكويت) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإصدار", required: true, type: "text", group: "معلومات الوثيقة", placeholder: "الكويت" },

    { key: "insurerName", label: "اسم شركة التأمين (المؤمِّن)", required: true, type: "text", group: "المؤمِّن" },
    { key: "insurerLicense", label: "رقم ترخيص وحدة تنظيم التأمين/السجل التجاري", required: true, type: "text", group: "المؤمِّن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق قانون تنظيم التأمين رقم 125 لسنة 2019 والقواعد العامة للقانون المدني الكويتي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">التأمين عقد يلتزم المؤمِّن بمقتضاه أن يؤدّي إلى المؤمَّن له أو المستفيد مبلغاً من المال أو إيراداً أو أي عوض مالي آخر عند تحقّق الخطر المؤمَّن منه، مقابل قسط يؤدّيه المؤمَّن له، ويصدر عن شركة مرخّصة تحت إشراف وحدة تنظيم التأمين.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> وأحكام قانون تنظيم التأمين رقم 125 لسنة 2019.</li>
...
export const INSURANCE_KW_EN: ContractTemplate = {
  id: 14202,
  slug: "kw-insurance-en",
  title: "Insurance Policy / Contract (Kuwait) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "KW",
  fields: [
    ...
    { key: "contractCity", label: "Place of Issue", required: true, type: "text", group: "Policy Info", placeholder: "Kuwait City" },

    { key: "insurerName", label: "Insurer (Company) Name", required: true, type: "text", group: "Insurer" },
    { key: "insurerLicense", label: "IRU Licence / CR", required: true, type: "text", group: "Insurer" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Issued under the Insurance Regulation Law No. 125 of 2019 (Insurance Regulatory Unit), with the general contract rules of the Kuwaiti Civil Code.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Subject & Cover</h3><div class="box">
    ...
    <div class="muted">Insurance is a contract whereby the insurer, against a premium, undertakes to pay the insured or beneficiary a sum or benefit on the occurrence of the insured event; cover is written by a company licensed and supervised by the Insurance Regulatory Unit.</div>
  </div></div>
