// lib/contracts/kw/services.ts
// عقود الخدمات الكويتية (استشارة، تدريب، تسويق، تطوير برمجي، خدمات إلكترونية، ترخيص، إدارة).
// تخضع للقواعد العامة للعقود في القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980) — القوة الملزمة
// للعقد وتنفيذه بحسن النية — مع مراعاة الأنظمة الخاصة: قانون حق المؤلف والحقوق المجاورة رقم 22 لسنة 2016،
// قانون المعاملات الإلكترونية رقم 20 لسنة 2014 ولائحة حماية خصوصية البيانات الصادرة عن هيئة الاتصالات (CITRA)،
...
function buildServiceContract(s: ServiceSpec): {
  ...
  <div class="box">
    ...
    <div class="clause">تخضع حقوق المؤلف والحقوق المجاورة والمصنفات (ومنها البرمجيات) لأحكام قانون حق المؤلف والحقوق المجاورة الكويتي رقم 22 لسنة 2016؛ ولا يجوز لأي طرف استعمال علامات أو مصنفات الطرف الآخر خارج حدود هذا العقد.</div>
  </div>`
    : "";
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="clause">العقد ملزم للطرفين فلا يجوز نقضه ولا تعديله إلا باتفاقهما أو للأسباب التي يقرّرها القانون، ويجب تنفيذه بما يتفق مع حسن النية، عملاً بأحكام القانون المدني الكويتي.</div>
  </div>
...
${arIpBlock}
  ...
  <div class="sec"><h3>5. Intellectual Property</h3><div class="box">
    <div>{{ipOwnership}}</div>
    <div class="muted">Copyright, neighbouring rights and works (including software) are subject to the Kuwaiti Copyright and Neighbouring Rights Law No. 22 of 2016; neither party may use the other's marks or works beyond this contract.</div>
  </div></div>`
    : "";
  ...
  const EN: ContractTemplate = {
    id: s.idBase + 2,
    slug: `kw-${s.slug}-en`,
    title: `${s.titleEn} (Kuwait) — English`,
    lang: "en",
    group: "PRO",
    jurisdiction: "KW",
    fields: enFields,
...
const GENERAL_LAW_AR =
  "مصاغ وفق القواعد العامة للعقود في القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980)";
const GENERAL_LAW_EN =
  "Governed by the general contract rules of the Kuwaiti Civil Code (Decree-Law No. 67 of 1980)";

const consultancy = buildServiceContract({
  idBase: 14300, slug: "consultancy",
...
const marketing = buildServiceContract({
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980)، ومع مراعاة قانون حماية المستهلك رقم 39 لسنة 2014",
  lawNoteEn:
    "Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980), with regard to the Consumer Protection Law No. 39 of 2014",
  withIp: true,
});

const software = buildServiceContract({
  idBase: 14600, slug: "software-development",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980)، ومع مراعاة قانون حق المؤلف والحقوق المجاورة رقم 22 لسنة 2016",
  lawNoteEn:
    "Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980), with regard to the Copyright and Neighbouring Rights Law No. 22 of 2016",
  withIp: true,
});

const eservices = buildServiceContract({
  idBase: 14700, slug: "e-services",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني الكويتي (المرسوم بقانون رقم 67 لسنة 1980)، ومع مراعاة قانون المعاملات الإلكترونية رقم 20 لسنة 2014 ولائحة حماية خصوصية البيانات (CITRA)",
  lawNoteEn:
    "Governed by the Kuwaiti Civil Code (Decree-Law No. 67 of 1980), with regard to the Electronic Transactions Law No. 20 of 2014 and the CITRA Data Privacy Protection Regulation",
  withIp: true,
});

const licensing = buildServiceContract({
  idBase: 14800, slug: "licensing",
