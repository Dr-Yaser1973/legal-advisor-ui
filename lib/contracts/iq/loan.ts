// lib/contracts/iq/loan.ts
// عقد قرض وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام القرض).
...
export const LOAN_IQ_AR: ContractTemplate = {
  id: 9401,
  slug: "iq-loan-ar",
  title: "عقد قرض (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "lenderId", label: "هوية/سجل المُقرِض", required: true, type: "text", group: "المُقرِض" },
    ...
    { key: "borrowerId", label: "هوية/سجل المُقترِض", required: true, type: "text", group: "المُقترِض" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام القرض)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يقرّ المُقترِض باستلام مبلغ القرض من المُقرِض على الوجه المبيّن أعلاه، ويلتزم بردّ مثله جنساً وقدراً وصفةً في ميعاد الاستحقاق، عملاً بأحكام القرض في القانون المدني العراقي.</div>
  </div>
...
export const LOAN_IQ_EN: ContractTemplate = {
  id: 9402,
  slug: "iq-loan-en",
  title: "Loan Agreement (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 (Loan provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Loan Amount & Disbursement</h3><div class="box">
    ...
    <div class="muted">The Borrower acknowledges receipt and undertakes to repay the like in kind, quantity and quality at maturity under the Iraqi Civil Code.</div>
  </div></div>
