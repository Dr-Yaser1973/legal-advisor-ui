// lib/contracts/iq/insurance.ts
// عقد (وثيقة) تأمين وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام التأمين)،
// ومع مراعاة قانون تنظيم أعمال التأمين النافذ.
...
export const INSURANCE_IQ_AR: ContractTemplate = {
  id: 9701,
  slug: "iq-insurance-ar",
  title: "عقد (وثيقة) تأمين (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإصدار", required: true, type: "text", group: "معلومات الوثيقة", placeholder: "بغداد" },
    ...
    { key: "insuredId", label: "هوية/سجل المؤمَّن له", required: true, type: "text", group: "المؤمَّن له" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 وقانون تنظيم أعمال التأمين</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">التأمين عقد يلتزم المؤمِّن بمقتضاه أن يؤدّي إلى المؤمَّن له أو المستفيد مبلغاً من المال أو إيراداً أو أي عوض مالي آخر عند تحقّق الخطر المؤمَّن منه، مقابل قسط يؤدّيه المؤمَّن له، عملاً بأحكام التأمين في القانون المدني العراقي.</div>
  </div>
...
export const INSURANCE_IQ_EN: ContractTemplate = {
  id: 9702,
  slug: "iq-insurance-en",
  title: "Insurance Policy / Contract (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "contractCity", label: "Place of Issue", required: true, type: "text", group: "Policy Info", placeholder: "Baghdad" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 and the insurance regulation law.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Subject & Cover</h3><div class="box">
    ...
    <div class="muted">Insurance is a contract whereby the insurer, against a premium, undertakes to pay the insured or beneficiary a sum or benefit on the occurrence of the insured event, under the Iraqi Civil Code.</div>
  </div></div>
