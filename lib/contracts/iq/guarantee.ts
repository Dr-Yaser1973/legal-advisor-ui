// lib/contracts/iq/guarantee.ts
// عقد كفالة وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الكفالة).
...
export const GUARANTEE_IQ_AR: ContractTemplate = {
  id: 9301,
  slug: "iq-guarantee-ar",
  title: "عقد كفالة (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "creditorId", label: "هوية/سجل الدائن", required: true, type: "text", group: "الدائن" },
    ...
    { key: "debtorId", label: "هوية/سجل المدين", required: true, type: "text", group: "المدين الأصلي" },
    ...
    { key: "guarantorId", label: "هوية/سجل الكفيل", required: true, type: "text", group: "الكفيل" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الكفالة)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يكفل الكفيل تنفيذ التزام المدين إذا لم يفِ به المدين نفسه، ولا تصحّ الكفالة إلا إذا كان الالتزام المكفول صحيحاً، عملاً بأحكام الكفالة في القانون المدني العراقي.</div>
  </div>
...
export const GUARANTEE_IQ_EN: ContractTemplate = {
  id: 9302,
  slug: "iq-guarantee-en",
  title: "Suretyship / Guarantee (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 (Suretyship provisions).</div>
    </div>
    <div class="meta">
