// lib/contracts/iq/agency.ts
// عقد وكالة وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الوكالة).
...
export const AGENCY_IQ_AR: ContractTemplate = {
  id: 9101,
  slug: "iq-agency-ar",
  title: "عقد وكالة (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "principalId", label: "هوية/سجل الموكِّل", required: true, type: "text", group: "الموكِّل" },
    ...
    { key: "agentId", label: "هوية/سجل الوكيل", required: true, type: "text", group: "الوكيل" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الوكالة)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الوكالة العامة لا تخوّل الوكيل إلا أعمال الإدارة. أما البيع والرهن والتبرع والصلح والإقرار وسائر التصرفات التي تخرج عن الإدارة فلا بدّ فيها من تفويض خاص صريح، عملاً بأحكام الوكالة في القانون المدني العراقي.</div>
...
export const AGENCY_IQ_EN: ContractTemplate = {
  id: 9102,
  slug: "iq-agency-en",
  title: "Agency / Mandate Agreement (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 (Mandate provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Scope</h3><div class="box">
    ...
    <div class="muted">A general mandate covers only acts of administration; sale, mortgage, donation, settlement, admission and other acts beyond administration require express special authority under the Iraqi Civil Code.</div>
