// lib/contracts/iq/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الرهن الحيازي).
...
export const PLEDGE_IQ_AR: ContractTemplate = {
  id: 9201,
  slug: "iq-pledge-ar",
  title: "عقد رهن حيازي (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "pledgorId", label: "هوية/سجل الراهن", required: true, type: "text", group: "الراهن" },
    ...
    { key: "pledgeeId", label: "هوية/سجل المرتهن", required: true, type: "text", group: "المرتهن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الرهن الحيازي)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في القانون المدني العراقي.</div>
  </div>
...
export const PLEDGE_IQ_EN: ContractTemplate = {
  id: 9202,
  slug: "iq-pledge-en",
  title: "Possessory Pledge Agreement (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 (Possessory Pledge provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>3. Pledged Asset & Possession</h3><div class="box">
    ...
    <div class="muted">A possessory pledge is perfected only by delivering the asset to the Pledgee or an agreed custodian; it is retained as security for the debt and its accessories under the Iraqi Civil Code.</div>
  </div></div>
