// lib/contracts/iq/settlement.ts
// عقد صلح وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الصلح).
...
export const SETTLEMENT_IQ_AR: ContractTemplate = {
  id: 9601,
  slug: "iq-settlement-ar",
  title: "عقد صلح (العراق) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
    ...
    { key: "party1Id", label: "هوية/سجل الطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "هوية/سجل الطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني العراقي رقم 40 لسنة 1951 (أحكام الصلح)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في القانون المدني العراقي.</div>
  </div>
...
export const SETTLEMENT_IQ_EN: ContractTemplate = {
  id: 9602,
  slug: "iq-settlement-en",
  title: "Settlement Agreement (Iraq) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "IQ",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Iraqi Civil Code No. 40 of 1951 (Compromise/Settlement provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. The Dispute</h3><div class="box">
    ...
    <div class="muted">A settlement is a contract by which the parties end an existing dispute or prevent a potential one through reciprocal concessions, under the Iraqi Civil Code.</div>
  </div></div>
