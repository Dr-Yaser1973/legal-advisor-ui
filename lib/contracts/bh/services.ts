// lib/contracts/bh/services.ts
// عقود الخدمات البحرينية (استشارة، تدريب، تسويق، تطوير برمجي، خدمات إلكترونية، ترخيص، إدارة).
// تخضع للقواعد العامة للعقود في القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001)
// — القوة الملزمة للعقد وتنفيذه بحسن النية — مع مراعاة الأنظمة الخاصة: قانون حماية حقوق المؤلف
// والحقوق المجاورة رقم 22 لسنة 2006، قانون الاتصالات والمعاملات الإلكترونية رقم 54 لسنة 2018،
// قانون حماية البيانات الشخصية رقم 30 لسنة 2018، قانون حماية المستهلك رقم 35 لسنة 2012.
...
function buildServiceContract(s: ServiceSpec): {
  ...
  const arFields: ContractField[] = [
    ...
    { key: "providerId", label: "الرقم الشخصي/السجل التجاري", required: true, type: "text", group: s.providerAr },
    ...
    { key: "clientId", label: "الرقم الشخصي/السجل التجاري", required: true, type: "text", group: s.clientAr },
  ...
  arFields.push(
    ...
    { key: "governingLaw", label: "القانون الواجب التطبيق", required: true, type: "text", group: "أحكام", placeholder: BH.governingLawAr },
    { key: "disputeCity", label: "الاختصاص المكاني (المحكمة)", required: true, type: "text", group: "أحكام", placeholder: BH.defaultCourtCityAr },
  );
  ...
  <div class="box">
    ...
    <div class="clause">تخضع حقوق المؤلف والحقوق المجاورة والمصنفات (ومنها البرمجيات) لأحكام قانون حماية حقوق المؤلف والحقوق المجاورة البحريني رقم 22 لسنة 2006؛ ولا يجوز لأي طرف استعمال علامات أو مصنفات الطرف الآخر خارج حدود هذا العقد.</div>
  </div>`
    : "";
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="p"><b>${s.providerAr}:</b> {{providerName}} — الرقم الشخصي/السجل: {{providerId}} — العنوان: {{providerAddress}}</div>
    <div class="p"><b>${s.clientAr}:</b> {{clientName}} — الرقم الشخصي/السجل: {{clientId}} — العنوان: {{clientAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">العقد ملزم للطرفين فلا يجوز نقضه ولا تعديله إلا باتفاقهما أو للأسباب التي يقرّرها القانون، ويجب تنفيذه بما يتفق مع حسن النية، عملاً بأحكام القانون المدني البحريني.</div>
  </div>
...
${arIpBlock}
  ...
  <div class="sec"><h3>5. Intellectual Property</h3><div class="box">
    <div>{{ipOwnership}}</div>
    <div class="muted">Copyright, neighbouring rights and works (including software) are subject to the Bahraini Copyright and Neighbouring Rights Law No. 22 of 2006; neither party may use the other's marks or works beyond this contract.</div>
  </div></div>`
    : "";
  ...
  const EN: ContractTemplate = {
    id: s.idBase + 2,
    slug: `bh-${s.slug}-en`,
    title: `${s.titleEn} (Bahrain) — English`,
    lang: "en",
    group: "PRO",
    jurisdiction: "BH",
    fields: enFields,
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="sec"><h3>2. Scope & Deliverables</h3><div class="box">
    ...
    <div class="muted">This Agreement is binding on the Parties and may be amended or rescinded only by mutual consent or on grounds provided by law, and must be performed in good faith under the Civil Code.</div>
  </div></div>
...
const GENERAL_LAW_AR =
  "مصاغ وفق القواعد العامة للعقود في القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001)";
const GENERAL_LAW_EN =
  "Governed by the general contract rules of the Bahraini Civil Code (Decree-Law No. 19 of 2001)";

const consultancy = buildServiceContract({
  idBase: 20300, slug: "consultancy",
...
const marketing = buildServiceContract({
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001)، ومع مراعاة قانون حماية المستهلك رقم 35 لسنة 2012",
  lawNoteEn:
    "Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001), with regard to the Consumer Protection Law No. 35 of 2012",
  withIp: true,
});

const software = buildServiceContract({
  idBase: 20600, slug: "software-development",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001)، ومع مراعاة قانون حماية حقوق المؤلف والحقوق المجاورة رقم 22 لسنة 2006",
  lawNoteEn:
    "Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001), with regard to the Copyright and Neighbouring Rights Law No. 22 of 2006",
  withIp: true,
});

const eservices = buildServiceContract({
  idBase: 20700, slug: "e-services",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001)، ومع مراعاة قانون الاتصالات والمعاملات الإلكترونية رقم 54 لسنة 2018 وقانون حماية البيانات الشخصية رقم 30 لسنة 2018",
  lawNoteEn:
    "Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001), with regard to the Electronic Communications and Transactions Law No. 54 of 2018 and the Personal Data Protection Law No. 30 of 2018",
  withIp: true,
});

const licensing = buildServiceContract({
  idBase: 20800, slug: "licensing",
