// lib/contracts/bh/partnership.ts
// عقد شركة/شراكة وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الشركة،
// وللشركات التجارية يُراعى قانون الشركات التجارية الصادر بالمرسوم بقانون رقم 21 لسنة 2001.
...
export const PARTNERSHIP_BH_AR: ContractTemplate = {
  id: 19501,
  slug: "bh-partnership-ar",
  title: "عقد شراكة (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "partner1Id", label: "الرقم الشخصي للشريك الأول", required: true, type: "text", group: "الشركاء" },
    ...
    { key: "partner2Id", label: "الرقم الشخصي للشريك الثاني", required: true, type: "text", group: "الشركاء" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الشركة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الشريك الأول:</b> {{partner1Name}} — الرقم الشخصي: {{partner1Id}} — العنوان: {{partner1Address}}</div>
    <div class="p"><b>الشريك الثاني:</b> {{partner2Name}} — الرقم الشخصي: {{partner2Id}} — العنوان: {{partner2Address}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يكون له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في القانون المدني البحريني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام قانون الشركات التجارية رقم 21 لسنة 2001 إن كانت الشركة تجارية، مع استكمال إجراءات التأسيس والقيد لدى وزارة الصناعة والتجارة).</li>
...
export const PARTNERSHIP_BH_EN: ContractTemplate = {
  id: 19502,
  slug: "bh-partnership-en",
  title: "Partnership Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "partner1Id", label: "Partner 1 CPR", required: true, type: "text", group: "Partners" },
    ...
    { key: "partner2Id", label: "Partner 2 CPR", required: true, type: "text", group: "Partners" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001); the Commercial Companies Law applies to commercial companies.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Partners</h3>
    <div><b>Partner 1:</b> {{partner1Name}} — CPR: {{partner1Id}} — {{partner1Address}}</div>
    <div><b>Partner 2:</b> {{partner2Name}} — CPR: {{partner2Id}} — {{partner2Address}}</div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Where the entity is a commercial company, the Commercial Companies Law (Decree-Law No. 21 of 2001) applies and the incorporation and registration formalities are completed with the Ministry of Industry and Commerce.</div>
  </div></div>
