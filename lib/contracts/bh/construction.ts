// lib/contracts/bh/construction.ts
// عقد مقاولة وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام المقاولة،
// والضمان العشري للمباني والمنشآت الثابتة (المواد 615–620: مسؤولية المقاول والمهندس بالتضامن،
// وهي من النظام العام لا يجوز الاتفاق على إعفائها).
...
export const CONSTRUCTION_BH_AR: ContractTemplate = {
  id: 19401,
  slug: "bh-construction-ar",
  title: "عقد مقاولة (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "ownerId", label: "الرقم الشخصي/السجل لرب العمل", required: true, type: "text", group: "رب العمل" },
    ...
    { key: "contractorId", label: "السجل التجاري/الرقم الشخصي للمقاول", required: true, type: "text", group: "المقاول" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام المقاولة والضمان العشري</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">رب العمل</td><td><b>الاسم:</b> {{ownerName}} — <b>الرقم الشخصي/السجل:</b> {{ownerId}} — <b>العنوان:</b> {{ownerAddress}}</td></tr>
      <tr><td class="th">المقاول</td><td><b>الاسم:</b> {{contractorName}} — <b>الرقم الشخصي/السجل:</b> {{contractorId}} — <b>العنوان:</b> {{contractorAddress}}</td></tr>
    </table>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا تعهّد المقاول بتقديم مادة العمل كلها أو بعضها كان مسؤولاً عن جودتها ويضمنها لرب العمل، عملاً بأحكام المقاولة في القانون المدني البحريني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>في مقاولات المباني والمنشآت الثابتة يضمن المقاول والمهندس بالتضامن ما يقع خلال عشر سنوات من تهدّم كلي أو جزئي أو عيب يهدّد متانة البناء وسلامته. وهذا الضمان من النظام العام فلا يجوز الاتفاق على إعفائه أو الحدّ منه (المواد 615–620 من القانون المدني البحريني).</li>
    </ol>
  </div>
...
export const CONSTRUCTION_BH_EN: ContractTemplate = {
  id: 19402,
  slug: "bh-construction-en",
  title: "Construction / Works Contract (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "ownerId", label: "Owner CPR / CR", required: true, type: "text", group: "Owner" },
    ...
    { key: "contractorId", label: "Contractor CR / CPR", required: true, type: "text", group: "Contractor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Muqawala; decennial liability, Arts. 615–620.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Owner:</b> {{ownerName}}<br/><b>CPR/CR:</b> {{ownerId}}<br/><b>Address:</b> {{ownerAddress}}</div>
      <div><b>Contractor:</b> {{contractorName}}<br/><b>CPR/CR:</b> {{contractorId}}<br/><b>Address:</b> {{contractorAddress}}</div>
    </div>
  </div></div>
  ...
  <div class="sec"><h3>2. Scope of Works</h3><div class="box">
    ...
    <div class="muted">Where the Contractor supplies the materials, it warrants their quality to the Owner under the Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty & Liability</h3><div class="box">
    ...
    <div class="muted">For buildings and fixed structures, the Contractor and the engineer are jointly and severally liable for total or partial collapse and for defects threatening the building's stability and safety for ten years from delivery. This liability is a matter of public policy and may not be excluded or limited by agreement (Arts. 615–620 Bahraini Civil Code).</div>
  </div></div>
