// lib/contracts/bh/loan.ts
// عقد قرض وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام القرض.
// ملاحظة: تُراعى في احتساب الفوائد الحدود التي يقرّرها قانون التجارة رقم 7 لسنة 1987
// وتعليمات مصرف البحرين المركزي (الحد الأقصى لسعر الفائدة).
...
export const LOAN_BH_AR: ContractTemplate = {
  id: 19901,
  slug: "bh-loan-ar",
  title: "عقد قرض (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "lenderId", label: "الرقم الشخصي/السجل للمُقرِض", required: true, type: "text", group: "المُقرِض" },
    ...
    { key: "borrowerId", label: "الرقم الشخصي/السجل للمُقترِض", required: true, type: "text", group: "المُقترِض" },
    ...
    { key: "interestRate", label: "سعر الفائدة السنوي (إن وجدت)", required: false, type: "text", group: "الفائدة والسداد", placeholder: "مثال: وفق الحد الأقصى المقرّر من مصرف البحرين المركزي" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام القرض</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المُقرِض:</b> {{lenderName}} — الرقم الشخصي/السجل: {{lenderId}} — العنوان: {{lenderAddress}}</div>
    <div class="p"><b>المُقترِض:</b> {{borrowerName}} — الرقم الشخصي/السجل: {{borrowerId}} — العنوان: {{borrowerAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يقرّ المُقترِض باستلام مبلغ القرض من المُقرِض على الوجه المبيّن أعلاه، ويلتزم بردّ مثله جنساً وقدراً وصفةً في ميعاد الاستحقاق، عملاً بأحكام القرض في القانون المدني البحريني.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا اتُّفق على فائدة وجب ألا تجاوز الحد الأقصى الذي يقرّره قانون التجارة رقم 7 لسنة 1987 وتعليمات مصرف البحرين المركزي، وكل ما جاوز الحد المسموح يُخفَّض إليه.</div>
  </div>
...
export const LOAN_BH_EN: ContractTemplate = {
  id: 19902,
  slug: "bh-loan-en",
  title: "Loan Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "lenderId", label: "Lender CPR / CR", required: true, type: "text", group: "Lender" },
    ...
    { key: "borrowerId", label: "Borrower CPR / CR", required: true, type: "text", group: "Borrower" },
    ...
    { key: "interestRate", label: "Annual Interest Rate (if any)", required: false, type: "text", group: "Interest & Repayment", placeholder: "e.g. within the CBB maximum rate" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Loan provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Lender:</b> {{lenderName}} — CPR/CR: {{lenderId}} — {{lenderAddress}}</div>
    <div><b>Borrower:</b> {{borrowerName}} — CPR/CR: {{borrowerId}} — {{borrowerAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Interest & Repayment</h3><div class="box">
    ...
    <div class="muted">Where interest is agreed, it may not exceed the maximum set by the Commercial Law (Decree-Law No. 7 of 1987) and the Central Bank of Bahrain; any excess is reduced to the permitted limit.</div>
  </div></div>
