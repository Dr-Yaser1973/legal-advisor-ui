// lib/contracts/bh/sale.ts
// عقد بيع منقول وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) —
...
export const SALE_BH_AR: ContractTemplate = {
  id: 19101,
  slug: "bh-sale-movable-ar",
  title: "عقد بيع منقول (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>يضمن البائع خلوّ المبيع من العيوب الخفية التي تنقص من قيمته أو من الانتفاع به وفق أحكام القانون المدني البحريني، ما لم يُتفق على الإعفاء من الضمان في حدود ما يجيزه القانون ودون أن يعلم البائع بالعيب ويكتمه.</li>
...
export const SALE_BH_EN: ContractTemplate = {
  id: 19102,
  slug: "bh-sale-movable-en",
  title: "Movable Property Sale Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "sellerId", label: "Seller CPR / CR", required: true, type: "text", group: "Seller" },
    ...
    { key: "buyerId", label: "Buyer CPR / CR", required: true, type: "text", group: "Buyer" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001).</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Seller:</b> {{sellerName}}<br/><b>CPR/CR:</b> {{sellerId}}<br/><b>Address:</b> {{sellerAddress}}<br/><b>Contact:</b> {{sellerPhone}}</div>
      <div><b>Buyer:</b> {{buyerName}}<br/><b>CPR/CR:</b> {{buyerId}}<br/><b>Address:</b> {{buyerAddress}}<br/><b>Contact:</b> {{buyerPhone}}</div>
    </div>
  ...
  <div class="sec"><h3>6. Governing Law & Dispute Resolution</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the Kingdom of Bahrain apply and the competent court in {{contractCity}} has jurisdiction unless the Parties agree in writing to arbitration.</div>
