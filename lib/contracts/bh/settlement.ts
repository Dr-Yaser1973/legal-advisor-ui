// lib/contracts/bh/settlement.ts
// عقد صلح وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الصلح.
...
export const SETTLEMENT_BH_AR: ContractTemplate = {
  id: 20101,
  slug: "bh-settlement-ar",
  title: "عقد صلح (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "party1Id", label: "الرقم الشخصي/السجل للطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "الرقم الشخصي/السجل للطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الصلح</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الطرف الأول:</b> {{party1Name}} — الرقم الشخصي/السجل: {{party1Id}} — العنوان: {{party1Address}}</div>
    <div class="p"><b>الطرف الثاني:</b> {{party2Name}} — الرقم الشخصي/السجل: {{party2Id}} — العنوان: {{party2Address}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في القانون المدني البحريني.</div>
  </div>
...
export const SETTLEMENT_BH_EN: ContractTemplate = {
  id: 20102,
  slug: "bh-settlement-en",
  title: "Settlement Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "party1Id", label: "Party 1 CPR / CR", required: true, type: "text", group: "Party 1" },
    ...
    { key: "party2Id", label: "Party 2 CPR / CR", required: true, type: "text", group: "Party 2" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Compromise/Settlement provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Party 1:</b> {{party1Name}} — CPR/CR: {{party1Id}} — {{party1Address}}</div>
    <div><b>Party 2:</b> {{party2Name}} — CPR/CR: {{party2Id}} — {{party2Address}}</div>
  </div></div>
  ...
  <div class="sec"><h3>2. The Dispute</h3><div class="box">
    ...
    <div class="muted">A settlement is a contract by which the parties end an existing dispute or prevent a potential one through reciprocal concessions, under the Civil Code.</div>
  </div></div>
