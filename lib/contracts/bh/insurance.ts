// lib/contracts/bh/insurance.ts
// عقد (وثيقة) تأمين وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) (القواعد العامة)،
// وتحت إشراف مصرف البحرين المركزي المنظِّم لقطاع التأمين (قانون المصرف والمؤسسات المالية رقم 64 لسنة 2006).
...
export const INSURANCE_BH_AR: ContractTemplate = {
  id: 20201,
  slug: "bh-insurance-ar",
  title: "عقد (وثيقة) تأمين (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإصدار", required: true, type: "text", group: "معلومات الوثيقة", placeholder: "المنامة" },

    { key: "insurerName", label: "اسم شركة التأمين (المؤمِّن)", required: true, type: "text", group: "المؤمِّن" },
    { key: "insurerLicense", label: "رقم ترخيص مصرف البحرين المركزي/السجل التجاري", required: true, type: "text", group: "المؤمِّن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) وتحت إشراف مصرف البحرين المركزي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">التأمين عقد يلتزم المؤمِّن بمقتضاه أن يؤدّي إلى المؤمَّن له أو المستفيد مبلغاً من المال أو إيراداً أو أي عوض مالي آخر عند تحقّق الخطر المؤمَّن منه، مقابل قسط يؤدّيه المؤمَّن له، ويصدر عن شركة مرخّصة تحت إشراف مصرف البحرين المركزي.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> وتعليمات مصرف البحرين المركزي المنظِّمة لقطاع التأمين.</li>
...
export const INSURANCE_BH_EN: ContractTemplate = {
  id: 20202,
  slug: "bh-insurance-en",
  title: "Insurance Policy / Contract (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "contractCity", label: "Place of Issue", required: true, type: "text", group: "Policy Info", placeholder: "Manama" },

    { key: "insurerName", label: "Insurer (Company) Name", required: true, type: "text", group: "Insurer" },
    { key: "insurerLicense", label: "CBB Licence / CR", required: true, type: "text", group: "Insurer" },
    ...
    { key: "insuredId", label: "Insured CPR / CR", required: true, type: "text", group: "Insured" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) and supervised by the Central Bank of Bahrain.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    ...
    <div><b>Insured:</b> {{insuredName}} — CPR/CR: {{insuredId}} — {{insuredAddress}}</div>
  ...
  <div class="sec"><h3>2. Subject & Cover</h3><div class="box">
    ...
    <div class="muted">Insurance is a contract whereby the insurer, against a premium, undertakes to pay the insured or beneficiary a sum or benefit on the occurrence of the insured event; cover is written by a company licensed and supervised by the Central Bank of Bahrain.</div>
  </div></div>
