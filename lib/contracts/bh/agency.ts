// lib/contracts/bh/agency.ts
// عقد وكالة وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الوكالة،
// ولوكالات التوزيع والاستيراد التجارية يُراعى قانون الوكالات التجارية الصادر بالمرسوم بقانون رقم 10 لسنة 1992.
...
export const AGENCY_BH_AR: ContractTemplate = {
  id: 19601,
  slug: "bh-agency-ar",
  title: "عقد وكالة (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "principalId", label: "الرقم الشخصي/السجل للموكِّل", required: true, type: "text", group: "الموكِّل" },
    ...
    { key: "agentId", label: "الرقم الشخصي/السجل للوكيل", required: true, type: "text", group: "الوكيل" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الوكالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الموكِّل:</b> {{principalName}} — الرقم الشخصي/السجل: {{principalId}} — العنوان: {{principalAddress}}</div>
    <div class="p"><b>الوكيل:</b> {{agentName}} — الرقم الشخصي/السجل: {{agentId}} — العنوان: {{agentAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الوكالة العامة لا تخوّل الوكيل إلا أعمال الإدارة. أما البيع والرهن والتبرع والصلح والإقرار وسائر التصرفات التي تخرج عن الإدارة فلا بدّ فيها من تفويض خاص صريح، عملاً بأحكام الوكالة في القانون المدني البحريني.</div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (ولوكالات التوزيع والاستيراد التجارية يُراعى قانون الوكالات التجارية رقم 10 لسنة 1992 وقيدها لدى وزارة الصناعة والتجارة).</li>
...
export const AGENCY_BH_EN: ContractTemplate = {
  id: 19602,
  slug: "bh-agency-en",
  title: "Agency / Mandate Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "principalId", label: "Principal CPR / CR", required: true, type: "text", group: "Principal" },
    ...
    { key: "agentId", label: "Agent CPR / CR", required: true, type: "text", group: "Agent" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Mandate provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Principal:</b> {{principalName}} — CPR/CR: {{principalId}} — {{principalAddress}}</div>
    <div><b>Agent:</b> {{agentName}} — CPR/CR: {{agentId}} — {{agentAddress}}</div>
  </div></div>

  <div class="sec"><h3>2. Scope</h3><div class="box">
    <div><b>Scope:</b> {{scope}}</div>
    <div><b>Type:</b> {{agencyType}} &nbsp; <b>Sub-delegation:</b> {{subAgent}}</div>
    <div class="muted">A general mandate covers only acts of administration; sale, mortgage, donation, settlement, admission and other acts beyond administration require express special authority under the Civil Code.</div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Commercial distribution and import agencies are additionally subject to the Commercial Agencies Law (Decree-Law No. 10 of 1992) and its registration with the Ministry of Industry and Commerce.</div>
  </div></div>
