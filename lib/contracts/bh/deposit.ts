// lib/contracts/bh/deposit.ts
// عقد وديعة وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الوديعة.
...
export const DEPOSIT_BH_AR: ContractTemplate = {
  id: 20001,
  slug: "bh-deposit-ar",
  title: "عقد وديعة (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "depositorId", label: "الرقم الشخصي/السجل للمودِع", required: true, type: "text", group: "المودِع" },
    ...
    { key: "custodianId", label: "الرقم الشخصي/السجل للمودَع لديه", required: true, type: "text", group: "المودَع لديه" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الوديعة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المودِع:</b> {{depositorName}} — الرقم الشخصي/السجل: {{depositorId}} — العنوان: {{depositorAddress}}</div>
    <div class="p"><b>المودَع لديه:</b> {{custodianName}} — الرقم الشخصي/السجل: {{custodianId}} — العنوان: {{custodianAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">تُنقَل بالوديعة حيازة الشيء إلى المودَع لديه ليتولّى حفظه على أن يردّه عيناً عند طلب المودِع، عملاً بأحكام الوديعة في القانون المدني البحريني.</div>
  </div>
...
export const DEPOSIT_BH_EN: ContractTemplate = {
  id: 20002,
  slug: "bh-deposit-en",
  title: "Deposit / Bailment Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "depositorId", label: "Depositor CPR / CR", required: true, type: "text", group: "Depositor" },
    ...
    { key: "custodianId", label: "Depositary CPR / CR", required: true, type: "text", group: "Depositary" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Deposit provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Depositor:</b> {{depositorName}} — CPR/CR: {{depositorId}} — {{depositorAddress}}</div>
    <div><b>Depositary:</b> {{custodianName}} — CPR/CR: {{custodianId}} — {{custodianAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>2. Subject of Deposit</h3><div class="box">
    ...
    <div class="muted">The deposit transfers possession to the depositary for safekeeping, to be returned in specie on the depositor's demand, under the Civil Code.</div>
  </div></div>
