// lib/contracts/bh/guarantee.ts
// عقد كفالة وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الكفالة.
...
export const GUARANTEE_BH_AR: ContractTemplate = {
  id: 19801,
  slug: "bh-guarantee-ar",
  title: "عقد كفالة (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "creditorId", label: "الرقم الشخصي/السجل للدائن", required: true, type: "text", group: "الدائن" },
    ...
    { key: "debtorId", label: "الرقم الشخصي/السجل للمدين", required: true, type: "text", group: "المدين الأصلي" },
    ...
    { key: "guarantorId", label: "الرقم الشخصي/السجل للكفيل", required: true, type: "text", group: "الكفيل" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الكفالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الدائن:</b> {{creditorName}} — الرقم الشخصي/السجل: {{creditorId}} — العنوان: {{creditorAddress}}</div>
    <div class="p"><b>المدين الأصلي:</b> {{debtorName}} — الرقم الشخصي/السجل: {{debtorId}} — العنوان: {{debtorAddress}}</div>
    <div class="p"><b>الكفيل:</b> {{guarantorName}} — الرقم الشخصي/السجل: {{guarantorId}} — العنوان: {{guarantorAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يكفل الكفيل تنفيذ التزام المدين إذا لم يفِ به المدين نفسه، ولا تصحّ الكفالة إلا إذا كان الالتزام المكفول صحيحاً، عملاً بأحكام الكفالة في القانون المدني البحريني.</div>
  </div>
...
export const GUARANTEE_BH_EN: ContractTemplate = {
  id: 19802,
  slug: "bh-guarantee-en",
  title: "Suretyship / Guarantee (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "creditorId", label: "Creditor CPR / CR", required: true, type: "text", group: "Creditor" },
    ...
    { key: "debtorId", label: "Debtor CPR / CR", required: true, type: "text", group: "Principal Debtor" },
    ...
    { key: "guarantorId", label: "Guarantor CPR / CR", required: true, type: "text", group: "Guarantor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Suretyship provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Creditor:</b> {{creditorName}} — CPR/CR: {{creditorId}} — {{creditorAddress}}</div>
    <div><b>Principal Debtor:</b> {{debtorName}} — CPR/CR: {{debtorId}} — {{debtorAddress}}</div>
    <div><b>Guarantor:</b> {{guarantorName}} — CPR/CR: {{guarantorId}} — {{guarantorAddress}}</div>
  </div></div>
