// lib/contracts/bh/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الرهن الحيازي.
// وللرهن التجاري على المنقولات يُراعى قانون التجارة الصادر بالمرسوم بقانون رقم 7 لسنة 1987.
...
export const PLEDGE_BH_AR: ContractTemplate = {
  id: 19701,
  slug: "bh-pledge-ar",
  title: "عقد رهن حيازي (البحرين) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "pledgorId", label: "الرقم الشخصي/السجل للراهن", required: true, type: "text", group: "الراهن" },
    ...
    { key: "pledgeeId", label: "الرقم الشخصي/السجل للمرتهن", required: true, type: "text", group: "المرتهن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني البحريني (المرسوم بقانون رقم 19 لسنة 2001) — أحكام الرهن الحيازي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الراهن:</b> {{pledgorName}} — الرقم الشخصي/السجل: {{pledgorId}} — العنوان: {{pledgorAddress}}</div>
    <div class="p"><b>المرتهن (الدائن):</b> {{pledgeeName}} — الرقم الشخصي/السجل: {{pledgeeId}} — العنوان: {{pledgeeAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في القانون المدني البحريني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (وللرهن التجاري على المنقولات تُراعى أحكام قانون التجارة رقم 7 لسنة 1987).</li>
...
export const PLEDGE_BH_EN: ContractTemplate = {
  id: 19702,
  slug: "bh-pledge-en",
  title: "Possessory Pledge Agreement (Bahrain) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "BH",
  fields: [
    ...
    { key: "pledgorId", label: "Pledgor CPR / CR", required: true, type: "text", group: "Pledgor" },
    ...
    { key: "pledgeeId", label: "Pledgee CPR / CR", required: true, type: "text", group: "Pledgee" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Bahraini Civil Code (Decree-Law No. 19 of 2001) — Possessory Pledge provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Pledgor:</b> {{pledgorName}} — CPR/CR: {{pledgorId}} — {{pledgorAddress}}</div>
    <div><b>Pledgee (Creditor):</b> {{pledgeeName}} — CPR/CR: {{pledgeeId}} — {{pledgeeAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Pledged Asset & Possession</h3><div class="box">
    ...
    <div class="muted">A possessory pledge is perfected only by delivering the asset to the Pledgee or an agreed custodian; it is held as security for the debt and its accessories under the Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">A commercial pledge over movable assets is additionally subject to the Commercial Law (Decree-Law No. 7 of 1987).</div>
  </div></div>
