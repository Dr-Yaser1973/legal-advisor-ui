// lib/contracts/jo/settlement.ts
// عقد صلح وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الصلح).
...
export const SETTLEMENT_JO_AR: ContractTemplate = {
  id: 8101,
  slug: "jo-settlement-ar",
  title: "عقد صلح (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "party1Id", label: "الرقم الوطني/السجل للطرف الأول", required: true, type: "text", group: "الطرف الأول" },
    ...
    { key: "party2Id", label: "الرقم الوطني/السجل للطرف الثاني", required: true, type: "text", group: "الطرف الثاني" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الصلح)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الطرف الأول:</b> {{party1Name}} — الرقم الوطني/السجل: {{party1Id}} — العنوان: {{party1Address}}</div>
    <div class="p"><b>الطرف الثاني:</b> {{party2Name}} — الرقم الوطني/السجل: {{party2Id}} — العنوان: {{party2Address}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في القانون المدني الأردني.</div>
  </div>
...
export const SETTLEMENT_JO_EN: ContractTemplate = {
  id: 8102,
  slug: "jo-settlement-en",
  title: "Settlement Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Compromise/Settlement provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. The Dispute</h3><div class="box">
    ...
    <div class="muted">A settlement is a contract by which the parties end an existing dispute or prevent a potential one through reciprocal concessions, under the Jordanian Civil Code.</div>
  </div></div>
