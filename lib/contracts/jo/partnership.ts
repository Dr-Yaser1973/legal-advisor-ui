// lib/contracts/jo/partnership.ts
// عقد شركة/شراكة وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الشركة)،
// وللشركات التجارية تُراعى أيضاً أحكام قانون الشركات الأردني رقم 22 لسنة 1997 وتعديلاته.
...
export const PARTNERSHIP_JO_AR: ContractTemplate = {
  id: 7401,
  slug: "jo-partnership-ar",
  title: "عقد شراكة (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "partner1Id", label: "الرقم الوطني للشريك الأول", required: true, type: "text", group: "الشركاء" },
    ...
    { key: "partner2Id", label: "الرقم الوطني للشريك الثاني", required: true, type: "text", group: "الشركاء" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الشركة)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الشريك الأول:</b> {{partner1Name}} — الرقم الوطني: {{partner1Id}} — العنوان: {{partner1Address}}</div>
    <div class="p"><b>الشريك الثاني:</b> {{partner2Name}} — الرقم الوطني: {{partner2Id}} — العنوان: {{partner2Address}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يُقسَّم له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في القانون المدني الأردني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام قانون الشركات الأردني إن كانت الشركة تجارية).</li>
...
export const PARTNERSHIP_JO_EN: ContractTemplate = {
  id: 7402,
  slug: "jo-partnership-en",
  title: "Partnership Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Company provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">The Jordanian Companies Law applies where the entity is a commercial company.</div>
  </div></div>
