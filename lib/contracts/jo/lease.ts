// lib/contracts/jo/lease.ts
// عقد إيجار وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الإجارة)،
// مع مراعاة قانون المالكين والمستأجرين الأردني في الإيجارات الخاضعة له.
...
export const LEASE_JO_AR: ContractTemplate = {
  id: 7201,
  slug: "jo-lease-ar",
  title: "عقد إيجار (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "lessorId", label: "الرقم الوطني/السجل للمؤجر", required: true, type: "text", group: "المؤجر" },
    ...
    { key: "lesseeId", label: "الرقم الوطني/السجل للمستأجر", required: true, type: "text", group: "المستأجر" },
    ...
    { key: "governingLaw", label: "القانون الواجب التطبيق", required: true, type: "text", group: "أحكام إضافية", placeholder: JO.governingLawAr },
    { key: "disputeCity", label: "الاختصاص المكاني (محكمة)", required: true, type: "text", group: "أحكام إضافية", placeholder: JO.defaultCourtCityAr },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">المؤجر</td><td><b>الاسم:</b> {{lessorName}} — <b>الرقم الوطني/السجل:</b> {{lessorId}} — <b>العنوان:</b> {{lessorAddress}} — <b>الهاتف:</b> {{lessorPhone}}</td></tr>
      <tr><td class="th">المستأجر</td><td><b>الاسم:</b> {{lesseeName}} — <b>الرقم الوطني/السجل:</b> {{lesseeId}} — <b>العنوان:</b> {{lesseeAddress}} — <b>الهاتف:</b> {{lesseePhone}}</td></tr>
    </table>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم المستأجر باستعمال المأجور فيما أُعدّ له وبما لا يخالف الغرض المتفق عليه، وأن يبذل في المحافظة عليه عناية معقولة، عملاً بأحكام الإجارة في القانون المدني الأردني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يتحمّل المؤجر الإصلاحات الجسيمة الضرورية، ويتحمّل المستأجر الترميمات التأجيرية المعتادة، ما لم يُتفق على خلاف ذلك.</li>
      <li>لا يجوز للمستأجر التنازل عن الإيجار أو التأجير من الباطن إلا بموافقة المؤجر الخطية، ما لم يوجد اتفاق يبيح ذلك.</li>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>ينتهي الإيجار بانقضاء مدّته، ما لم يُتفق على خلاف ذلك، ومع مراعاة أحكام قانون المالكين والمستأجرين فيما يخضع له.</li>
      <li>يلتزم من يرغب في إنهاء العقد قبل مدّته بإشعار الطرف الآخر بمدة لا تقل عن <b>{{terminationNotice}}</b>.</li>
...
export const LEASE_JO_EN: ContractTemplate = {
  id: 7202,
  slug: "jo-lease-en",
  title: "Lease Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "contractCity", label: "Place/City of Execution", required: true, type: "text", group: "Contract Info", placeholder: "Amman" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Lease provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Premises & Use</h3><div class="box">
    ...
    <div class="muted">The Lessee shall use the premises for the agreed purpose and preserve them with reasonable care under the Jordanian Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>4. Maintenance & Termination</h3><div class="box">
    <div class="muted">
      (a) The Lessor bears necessary major repairs; the Lessee bears ordinary tenant repairs, unless otherwise agreed.<br/>
      ...
      (d) On expiry, the Lessee returns the premises in their received condition, subject to fair wear and tear; the Landlords and Tenants Law applies to leases within its scope.
    </div>
  </div></div>
  ...
  <div class="sec"><h3>5. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the Hashemite Kingdom of Jordan apply and the courts of {{contractCity}} have jurisdiction.</div>
  </div></div>
