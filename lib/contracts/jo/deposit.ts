// lib/contracts/jo/deposit.ts
// عقد وديعة وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الوديعة).
...
export const DEPOSIT_JO_AR: ContractTemplate = {
  id: 8001,
  slug: "jo-deposit-ar",
  title: "عقد وديعة (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "depositorId", label: "الرقم الوطني/السجل للمودِع", required: true, type: "text", group: "المودِع" },
    ...
    { key: "custodianId", label: "الرقم الوطني/السجل للمودَع لديه", required: true, type: "text", group: "المودَع لديه" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الوديعة)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المودِع:</b> {{depositorName}} — الرقم الوطني/السجل: {{depositorId}} — العنوان: {{depositorAddress}}</div>
    <div class="p"><b>المودَع لديه:</b> {{custodianName}} — الرقم الوطني/السجل: {{custodianId}} — العنوان: {{custodianAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">تُنقَل بالوديعة حيازة الشيء إلى المودَع لديه ليتولّى حفظه على أن يردّه عيناً عند طلب المودِع، عملاً بأحكام الوديعة في القانون المدني الأردني.</div>
  </div>
...
export const DEPOSIT_JO_EN: ContractTemplate = {
  id: 8002,
  slug: "jo-deposit-en",
  title: "Deposit / Bailment Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Deposit provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Subject of Deposit</h3><div class="box">
    ...
    <div class="muted">The deposit transfers possession to the depositary for safekeeping, to be returned in specie on the depositor's demand, under the Jordanian Civil Code.</div>
  </div></div>
