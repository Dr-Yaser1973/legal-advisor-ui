// lib/contracts/jo/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الرهن الحيازي).
...
export const PLEDGE_JO_AR: ContractTemplate = {
  id: 7701,
  slug: "jo-pledge-ar",
  title: "عقد رهن حيازي (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "pledgorId", label: "الرقم الوطني/السجل للراهن", required: true, type: "text", group: "الراهن" },
    ...
    { key: "pledgeeId", label: "الرقم الوطني/السجل للمرتهن", required: true, type: "text", group: "المرتهن" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام الرهن الحيازي)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>الراهن:</b> {{pledgorName}} — الرقم الوطني/السجل: {{pledgorId}} — العنوان: {{pledgorAddress}}</div>
    <div class="p"><b>المرتهن (الدائن):</b> {{pledgeeName}} — الرقم الوطني/السجل: {{pledgeeId}} — العنوان: {{pledgeeAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في القانون المدني الأردني.</div>
  </div>

  <div class="box">
    <div class="h">رابعاً: التزامات الطرفين</div>
    <ol class="ol">
      <li>يحافظ المرتهن (أو العدل) على المرهون بعناية معقولة، ويردّه عند الوفاء بالدين كاملاً.</li>
...
export const PLEDGE_JO_EN: ContractTemplate = {
  id: 7702,
  slug: "jo-pledge-en",
  title: "Possessory Pledge Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Possessory Pledge provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>3. Pledged Asset & Possession</h3><div class="box">
    ...
    <div class="muted">A possessory pledge is perfected only by delivering the asset to the Pledgee or an agreed custodian; it is retained as security for the debt and its accessories under the Jordanian Civil Code.</div>
  </div></div>

  <div class="sec"><h3>4. Obligations</h3><div class="box">
    <div class="muted">The Pledgee (or custodian) shall preserve the asset with reasonable care and return it upon full payment. Any clause vesting ownership of the pledged asset in the Pledgee upon default — or allowing its sale without the statutory procedure — is void.</div>
  </div></div>
