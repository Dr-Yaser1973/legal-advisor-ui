// lib/contracts/jo/sale.ts
// عقد بيع منقول وفق القانون المدني الأردني رقم 43 لسنة 1976
...
export const SALE_JO_AR: ContractTemplate = {
  id: 7101,
  slug: "jo-sale-movable-ar",
  title: "عقد بيع منقول (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "sellerId", label: "الرقم الوطني/السجل التجاري للبائع", required: true, type: "text", group: "البائع" },
    ...
    { key: "buyerId", label: "الرقم الوطني/السجل التجاري للمشتري", required: true, type: "text", group: "المشتري" },
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">البائع</td><td><b>الاسم:</b> {{sellerName}} — <b>الرقم الوطني/السجل:</b> {{sellerId}} — <b>العنوان:</b> {{sellerAddress}} — <b>الهاتف:</b> {{sellerPhone}}</td></tr>
      <tr><td class="th">المشتري</td><td><b>الاسم:</b> {{buyerName}} — <b>الرقم الوطني/السجل:</b> {{buyerId}} — <b>العنوان:</b> {{buyerAddress}} — <b>الهاتف:</b> {{buyerPhone}}</td></tr>
    </table>
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم المشتري بأداء الثمن في المكان والزمان المتفق عليهما، ويقرّ البائع باستلامه بحسب ما يثبت بالإيصالات عند الاقتضاء، والعقد ملزم للطرفين وفق القانون المدني الأردني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>يضمن البائع العيوب الخفية في المبيع وفقاً لأحكام القانون المدني الأردني، ما لم يُتفق على الإعفاء منها في حدود ما يجيزه القانون.</li>
...
export const SALE_JO_EN: ContractTemplate = {
  id: 7102,
  slug: "jo-sale-movable-en",
  title: "Movable Property Sale Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Seller:</b> {{sellerName}}<br/><b>ID/Reg:</b> {{sellerId}}<br/><b>Address:</b> {{sellerAddress}}<br/><b>Contact:</b> {{sellerPhone}}</div>
      <div><b>Buyer:</b> {{buyerName}}<br/><b>ID/Reg:</b> {{buyerId}}<br/><b>Address:</b> {{buyerAddress}}<br/><b>Contact:</b> {{buyerPhone}}</div>
    </div>
  ...
  <div class="sec"><h3>2. Subject Matter</h3><div class="box">
    ...
    <div class="muted">The Seller represents lawful ownership and that the item is free of third-party rights unless expressly disclosed.</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Price & Payment</h3><div class="box">
    ...
    <div class="muted">This Agreement is binding on the Parties under the Jordanian Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty of Title & Hidden Defects</h3><div class="box">
    ...
    <div class="muted">The Seller warrants quiet possession and remains liable for hidden defects under the Jordanian Civil Code, save for a lawful exclusion of liability.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Dispute Resolution</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the Hashemite Kingdom of Jordan apply and the courts of {{contractCity}} have jurisdiction unless otherwise agreed in writing.</div>
