// lib/contracts/jo/construction.ts
// عقد مقاولة وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام المقاولة،
// والضمان العشري للمباني والمنشآت الثابتة — المادة 788).
...
export const CONSTRUCTION_JO_AR: ContractTemplate = {
  id: 7301,
  slug: "jo-construction-ar",
  title: "عقد مقاولة (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "ownerId", label: "الرقم الوطني/السجل لرب العمل", required: true, type: "text", group: "رب العمل" },
    ...
    { key: "contractorId", label: "الرقم الوطني/السجل التجاري للمقاول", required: true, type: "text", group: "المقاول" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام المقاولة والضمان العشري م788)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">رب العمل</td><td><b>الاسم:</b> {{ownerName}} — <b>الرقم الوطني/السجل:</b> {{ownerId}} — <b>العنوان:</b> {{ownerAddress}}</td></tr>
      <tr><td class="th">المقاول</td><td><b>الاسم:</b> {{contractorName}} — <b>الرقم الوطني/السجل:</b> {{contractorId}} — <b>العنوان:</b> {{contractorAddress}}</td></tr>
    </table>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">في المقاولة بأجر إجمالي (مقطوع) لا يجوز للمقاول المطالبة بزيادة الأجر بسبب ارتفاع الأسعار أو تغيّر التكاليف، إلا في الحدود التي يقرّرها القانون.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>في مقاولات المباني والمنشآت الثابتة يضمن المقاول والمهندس (عند وجوده) متضامنين ما يحدث خلال عشر سنوات من تهدّم كلي أو جزئي أو عيب يهدد متانة البناء وسلامته، ما لم يتضمن العقد مدة أطول (الضمان العشري — المادة 788 من القانون المدني الأردني).</li>
    </ol>
  </div>
...
export const CONSTRUCTION_JO_EN: ContractTemplate = {
  id: 7302,
  slug: "jo-construction-en",
  title: "Construction / Works Contract (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Muqawala; decennial liability, Art. 788).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Scope of Works</h3><div class="box">
    ...
    <div class="muted">Where the Contractor supplies materials, it warrants their quality to the Owner.</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Price & Payment</h3><div class="box">
    ...
    <div class="muted">Under a lump-sum price the Contractor may not claim an increase merely because prices or costs changed, save as allowed by law.</div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty & Liability</h3><div class="box">
    ...
    <div class="muted">For buildings and fixed works, the Contractor and the engineer (if any) are jointly liable for total/partial collapse or defects threatening the building's stability and safety for ten years from delivery, unless a longer period is agreed (decennial liability, Art. 788 Jordanian Civil Code).</div>
  </div></div>
