// lib/contracts/jo/loan.ts
// عقد قرض وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام القرض).
// ملاحظة: تُراعى في احتساب الفوائد الحدود التي تقرّرها التشريعات النافذة.
...
export const LOAN_JO_AR: ContractTemplate = {
  id: 7901,
  slug: "jo-loan-ar",
  title: "عقد قرض (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "lenderId", label: "الرقم الوطني/السجل للمُقرِض", required: true, type: "text", group: "المُقرِض" },
    ...
    { key: "borrowerId", label: "الرقم الوطني/السجل للمُقترِض", required: true, type: "text", group: "المُقترِض" },
    ...
    { key: "interestRate", label: "سعر الفائدة السنوي (إن وجدت)", required: false, type: "text", group: "الفائدة والسداد", placeholder: "مثال: وفق المتفق عليه ضمن الحد المسموح" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام القرض)</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المُقرِض:</b> {{lenderName}} — الرقم الوطني/السجل: {{lenderId}} — العنوان: {{lenderAddress}}</div>
    <div class="p"><b>المُقترِض:</b> {{borrowerName}} — الرقم الوطني/السجل: {{borrowerId}} — العنوان: {{borrowerAddress}}</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">يقرّ المُقترِض باستلام مبلغ القرض من المُقرِض على الوجه المبيّن أعلاه، ويلتزم بردّ مثله جنساً وقدراً وصفةً في ميعاد الاستحقاق، عملاً بأحكام القرض في القانون المدني الأردني.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا اتُّفق على فائدة وجب أن تكون ضمن الحدود التي تقرّرها التشريعات النافذة، وكل ما جاوز الحد المسموح يُخفَّض إليه.</div>
  </div>
...
export const LOAN_JO_EN: ContractTemplate = {
  id: 7902,
  slug: "jo-loan-en",
  title: "Loan Agreement (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "interestRate", label: "Annual Interest Rate (if any)", required: false, type: "text", group: "Interest & Repayment" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 (Loan provisions).</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Loan Amount & Disbursement</h3><div class="box">
    ...
    <div class="muted">The Borrower acknowledges receipt and undertakes to repay the like in kind, quantity and quality at maturity under the Jordanian Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Interest & Repayment</h3><div class="box">
    ...
    <div class="muted">Where interest is agreed, it must fall within the limits set by the applicable legislation; any excess is reduced to the permitted limit.</div>
  </div></div>
