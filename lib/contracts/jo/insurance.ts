// lib/contracts/jo/insurance.ts
// عقد (وثيقة) تأمين وفق القانون المدني الأردني رقم 43 لسنة 1976 (أحكام التأمين)،
// ومع مراعاة قانون تنظيم أعمال التأمين الأردني (تحت إشراف البنك المركزي الأردني).
...
export const INSURANCE_JO_AR: ContractTemplate = {
  id: 8201,
  slug: "jo-insurance-ar",
  title: "عقد (وثيقة) تأمين (الأردن) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإصدار", required: true, type: "text", group: "معلومات الوثيقة", placeholder: "عمّان" },
    ...
    { key: "insuredId", label: "الرقم الوطني/السجل للمؤمَّن له", required: true, type: "text", group: "المؤمَّن له" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني الأردني رقم 43 لسنة 1976 وقانون تنظيم أعمال التأمين</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="p"><b>المؤمَّن له:</b> {{insuredName}} — الرقم الوطني/السجل: {{insuredId}} — العنوان: {{insuredAddress}}</div>
  ...
  <div class="box">
    ...
    <div class="clause">التأمين عقد يلتزم المؤمِّن بمقتضاه أن يؤدّي إلى المؤمَّن له أو المستفيد مبلغاً من المال أو إيراداً أو أي عوض مالي آخر عند تحقّق الخطر المؤمَّن منه، مقابل قسط يؤدّيه المؤمَّن له، عملاً بأحكام التأمين في القانون المدني الأردني.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> وأحكام قانون تنظيم أعمال التأمين.</li>
...
export const INSURANCE_JO_EN: ContractTemplate = {
  id: 8202,
  slug: "jo-insurance-en",
  title: "Insurance Policy / Contract (Jordan) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "JO",
  fields: [
    ...
    { key: "contractCity", label: "Place of Issue", required: true, type: "text", group: "Policy Info", placeholder: "Amman" },

    { key: "insurerName", label: "Insurer (Company) Name", required: true, type: "text", group: "Insurer" },
    { key: "insurerLicense", label: "Licence / Commercial Reg.", required: true, type: "text", group: "Insurer" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Jordanian Civil Code No. 43 of 1976 and the insurance regulation law.</div>
    </div>
    <div class="meta">
  ...
  <div class="sec"><h3>2. Subject & Cover</h3><div class="box">
    ...
    <div class="muted">Insurance is a contract whereby the insurer, against a premium, undertakes to pay the insured or beneficiary a sum or benefit on the occurrence of the insured event, under the Jordanian Civil Code.</div>
  </div></div>
