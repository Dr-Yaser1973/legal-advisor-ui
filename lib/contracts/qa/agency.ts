// lib/contracts/qa/agency.ts
// عقد وكالة وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الوكالة،
// ولوكالات التوزيع والاستيراد التجارية يُراعى قانون تنظيم الوكالات التجارية رقم 8 لسنة 2002.
...
export const AGENCY_QA_AR: ContractTemplate = {
  id: 15601,
  slug: "qa-agency-ar",
  title: "عقد وكالة (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الوكالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الوكالة العامة لا تخوّل الوكيل إلا أعمال الإدارة. أما البيع والرهن والتبرع والصلح والإقرار وسائر التصرفات التي تخرج عن الإدارة فلا بدّ فيها من تفويض خاص صريح، عملاً بأحكام الوكالة في القانون المدني القطري.</div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (ولوكالات التوزيع والاستيراد التجارية يُراعى قانون تنظيم الوكالات التجارية رقم 8 لسنة 2002 وقيدها لدى وزارة التجارة والصناعة).</li>
...
export const AGENCY_QA_EN: ContractTemplate = {
  id: 15602,
  slug: "qa-agency-en",
  title: "Agency / Mandate Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "principalId", label: "Principal QID / CR", required: true, type: "text", group: "Principal" },
    ...
    { key: "agentId", label: "Agent QID / CR", required: true, type: "text", group: "Agent" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Mandate provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Principal:</b> {{principalName}} — QID/CR: {{principalId}} — {{principalAddress}}</div>
    <div><b>Agent:</b> {{agentName}} — QID/CR: {{agentId}} — {{agentAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Commercial distribution and import agencies are additionally subject to the Commercial Agencies Law No. 8 of 2002 and its registration with the Ministry of Commerce and Industry.</div>
  </div></div>
