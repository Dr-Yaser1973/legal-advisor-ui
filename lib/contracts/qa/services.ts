// lib/contracts/qa/services.ts
// عقود الخدمات القطرية (استشارة، تدريب، تسويق، تطوير برمجي، خدمات إلكترونية، ترخيص، إدارة).
// تخضع للقواعد العامة للعقود في القانون المدني القطري رقم 22 لسنة 2004 (القوة الملزمة للعقد
// وتنفيذه بحسن النية) — مع مراعاة الأنظمة الخاصة: قانون حماية المصنفات الأدبية والفنية رقم 7 لسنة 2002،
// قانون المعاملات والتجارة الإلكترونية رقم 16 لسنة 2010، قانون حماية خصوصية البيانات الشخصية رقم 13 لسنة 2016،
// قانون حماية المستهلك رقم 8 لسنة 2008.
...
function buildServiceContract(s: ServiceSpec): {
  ...
  <div class="box">
    ...
    <div class="clause">تخضع حقوق المؤلف والحقوق المجاورة والمصنفات (ومنها البرمجيات) لأحكام قانون حماية المصنفات الأدبية والفنية القطري رقم 7 لسنة 2002؛ ولا يجوز لأي طرف استعمال علامات أو مصنفات الطرف الآخر خارج حدود هذا العقد.</div>
  </div>`
    : "";
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="clause">العقد ملزم للطرفين فلا يجوز نقضه ولا تعديله إلا باتفاقهما أو للأسباب التي يقرّرها القانون، ويجب تنفيذه بما يتفق مع حسن النية، عملاً بأحكام القانون المدني القطري.</div>
  </div>
...
${arIpBlock}
  ...
  <div class="sec"><h3>5. Intellectual Property</h3><div class="box">
    <div>{{ipOwnership}}</div>
    <div class="muted">Copyright, neighbouring rights and works (including software) are subject to the Qatari Law on the Protection of Literary and Artistic Works No. 7 of 2002; neither party may use the other's marks or works beyond this contract.</div>
  </div></div>`
    : "";
...
const GENERAL_LAW_AR =
  "مصاغ وفق القواعد العامة للعقود في القانون المدني القطري رقم 22 لسنة 2004";
const GENERAL_LAW_EN =
  "Governed by the general contract rules of the Qatari Civil Code (Law No. 22 of 2004)";

const consultancy = buildServiceContract({
  idBase: 16300, slug: "consultancy",
...
const marketing = buildServiceContract({
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004، ومع مراعاة قانون حماية المستهلك رقم 8 لسنة 2008",
  lawNoteEn:
    "Governed by the Qatari Civil Code (Law No. 22 of 2004), with regard to the Consumer Protection Law No. 8 of 2008",
  withIp: true,
});

const software = buildServiceContract({
  idBase: 16600, slug: "software-development",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004، ومع مراعاة قانون حماية المصنفات الأدبية والفنية رقم 7 لسنة 2002",
  lawNoteEn:
    "Governed by the Qatari Civil Code (Law No. 22 of 2004), with regard to the Law on the Protection of Literary and Artistic Works No. 7 of 2002",
  withIp: true,
});

const eservices = buildServiceContract({
  idBase: 16700, slug: "e-services",
  ...
  lawNoteAr:
    "مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004، ومع مراعاة قانون المعاملات والتجارة الإلكترونية رقم 16 لسنة 2010 وقانون حماية خصوصية البيانات الشخصية رقم 13 لسنة 2016",
  lawNoteEn:
    "Governed by the Qatari Civil Code (Law No. 22 of 2004), with regard to the Electronic Commerce and Transactions Law No. 16 of 2010 and the Personal Data Privacy Protection Law No. 13 of 2016",
  withIp: true,
});

const licensing = buildServiceContract({
  idBase: 16800, slug: "licensing",
