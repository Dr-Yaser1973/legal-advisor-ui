// lib/contracts/qa/settlement.ts
// عقد صلح وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الصلح.
...
export const SETTLEMENT_QA_AR: ContractTemplate = {
  id: 16101,
  slug: "qa-settlement-ar",
  title: "عقد صلح (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الصلح</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">الصلح عقد يحسم به الطرفان نزاعاً قائماً أو يتوقّيان به نزاعاً محتملاً، بأن ينزل كلٌّ منهما على وجه التقابل عن جزء من ادّعائه، عملاً بأحكام الصلح في القانون المدني القطري.</div>
  </div>
...
export const SETTLEMENT_QA_EN: ContractTemplate = {
  id: 16102,
  slug: "qa-settlement-en",
  title: "Settlement Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "party1Id", label: "Party 1 QID / CR", required: true, type: "text", group: "Party 1" },
    ...
    { key: "party2Id", label: "Party 2 QID / CR", required: true, type: "text", group: "Party 2" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Compromise/Settlement provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Party 1:</b> {{party1Name}} — QID/CR: {{party1Id}} — {{party1Address}}</div>
    <div><b>Party 2:</b> {{party2Name}} — QID/CR: {{party2Id}} — {{party2Address}}</div>
  </div></div>
