// lib/contracts/qa/partnership.ts
// عقد شركة/شراكة وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الشركة،
// وللشركات التجارية يُراعى قانون الشركات التجارية رقم 11 لسنة 2015 وتعديلاته.
...
export const PARTNERSHIP_QA_AR: ContractTemplate = {
  id: 15501,
  slug: "qa-partnership-ar",
  title: "عقد شراكة (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الشركة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">تكون حصة كل شريك محلاً لالتزامه، ومن قدّم حصة عملٍ يكون له نصيب في الربح وفق الاتفاق دون أن تدخل قيمة عمله في رأس المال، عملاً بأحكام الشركة في القانون المدني القطري.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد وكل ما لم يرد فيه نصّ لأحكام <b>{{governingLaw}}</b> (ولأحكام قانون الشركات التجارية رقم 11 لسنة 2015 إن كانت الشركة تجارية، مع استكمال إجراءات التأسيس والقيد لدى وزارة التجارة والصناعة).</li>
...
export const PARTNERSHIP_QA_EN: ContractTemplate = {
  id: 15502,
  slug: "qa-partnership-en",
  title: "Partnership Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "partner1Id", label: "Partner 1 QID", required: true, type: "text", group: "Partners" },
    ...
    { key: "partner2Id", label: "Partner 2 QID", required: true, type: "text", group: "Partners" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004); the Commercial Companies Law applies to commercial companies.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Partners</h3>
    <div><b>Partner 1:</b> {{partner1Name}} — QID: {{partner1Id}} — {{partner1Address}}</div>
    <div><b>Partner 2:</b> {{partner2Name}} — QID: {{partner2Id}} — {{partner2Address}}</div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">Where the entity is a commercial company, the Commercial Companies Law No. 11 of 2015 applies and the incorporation and registration formalities are completed with the Ministry of Commerce and Industry.</div>
  </div></div>
