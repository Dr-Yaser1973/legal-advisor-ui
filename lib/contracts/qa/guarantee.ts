// lib/contracts/qa/guarantee.ts
// عقد كفالة وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الكفالة.
...
export const GUARANTEE_QA_AR: ContractTemplate = {
  id: 15801,
  slug: "qa-guarantee-ar",
  title: "عقد كفالة (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الكفالة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يكفل الكفيل تنفيذ التزام المدين إذا لم يفِ به المدين نفسه، ولا تصحّ الكفالة إلا إذا كان الالتزام المكفول صحيحاً، عملاً بأحكام الكفالة في القانون المدني القطري.</div>
  </div>
...
export const GUARANTEE_QA_EN: ContractTemplate = {
  id: 15802,
  slug: "qa-guarantee-en",
  title: "Suretyship / Guarantee (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "creditorId", label: "Creditor QID / CR", required: true, type: "text", group: "Creditor" },
    ...
    { key: "debtorId", label: "Debtor QID / CR", required: true, type: "text", group: "Principal Debtor" },
    ...
    { key: "guarantorId", label: "Guarantor QID / CR", required: true, type: "text", group: "Guarantor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Suretyship provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Creditor:</b> {{creditorName}} — QID/CR: {{creditorId}} — {{creditorAddress}}</div>
    <div><b>Principal Debtor:</b> {{debtorName}} — QID/CR: {{debtorId}} — {{debtorAddress}}</div>
    <div><b>Guarantor:</b> {{guarantorName}} — QID/CR: {{guarantorId}} — {{guarantorAddress}}</div>
  </div></div>
