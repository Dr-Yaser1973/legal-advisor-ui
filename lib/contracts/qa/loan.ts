// lib/contracts/qa/loan.ts
// عقد قرض وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام القرض.
// ملاحظة: تُراعى في احتساب الفوائد الحدود التي يقرّرها قانون التجارة رقم 27 لسنة 2006
// وتعليمات مصرف قطر المركزي (الحد الأقصى لسعر الفائدة).
...
export const LOAN_QA_AR: ContractTemplate = {
  id: 15901,
  slug: "qa-loan-ar",
  title: "عقد قرض (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "interestRate", label: "سعر الفائدة السنوي (إن وجدت)", required: false, type: "text", group: "الفائدة والسداد", placeholder: "مثال: وفق الحد الأقصى المقرّر من مصرف قطر المركزي" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام القرض</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">يقرّ المُقترِض باستلام مبلغ القرض من المُقرِض على الوجه المبيّن أعلاه، ويلتزم بردّ مثله جنساً وقدراً وصفةً في ميعاد الاستحقاق، عملاً بأحكام القرض في القانون المدني القطري.</div>
  </div>
  ...
  <div class="box">
    ...
    <div class="clause">إذا اتُّفق على فائدة وجب ألا تجاوز الحد الأقصى الذي يقرّره قانون التجارة رقم 27 لسنة 2006 وتعليمات مصرف قطر المركزي، وكل ما جاوز الحد المسموح يُخفَّض إليه.</div>
  </div>
...
export const LOAN_QA_EN: ContractTemplate = {
  id: 15902,
  slug: "qa-loan-en",
  title: "Loan Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "lenderId", label: "Lender QID / CR", required: true, type: "text", group: "Lender" },
    ...
    { key: "borrowerId", label: "Borrower QID / CR", required: true, type: "text", group: "Borrower" },
    ...
    { key: "interestRate", label: "Annual Interest Rate (if any)", required: false, type: "text", group: "Interest & Repayment", placeholder: "e.g. within the QCB maximum rate" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Loan provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Lender:</b> {{lenderName}} — QID/CR: {{lenderId}} — {{lenderAddress}}</div>
    <div><b>Borrower:</b> {{borrowerName}} — QID/CR: {{borrowerId}} — {{borrowerAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>3. Interest & Repayment</h3><div class="box">
    ...
    <div class="muted">Where interest is agreed, it may not exceed the maximum set by the Commercial Law (Law No. 27 of 2006) and the Qatar Central Bank; any excess is reduced to the permitted limit.</div>
  </div></div>
