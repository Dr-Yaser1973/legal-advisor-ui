// lib/contracts/qa/sale.ts
// عقد بيع منقول وفق القانون المدني القطري رقم 22 لسنة 2004 —
...
export const SALE_QA_AR: ContractTemplate = {
  id: 15101,
  slug: "qa-sale-movable-ar",
  title: "عقد بيع منقول (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "contractCity", label: "مدينة الإبرام", required: true, type: "text", group: "معلومات العقد", placeholder: "الدوحة" },

    { key: "sellerName", label: "اسم البائع", required: true, type: "text", group: "البائع" },
    { key: "sellerId", label: "الرقم الشخصي/السجل التجاري للبائع", required: true, type: "text", group: "البائع" },
    ...
    { key: "buyerId", label: "الرقم الشخصي/السجل التجاري للمشتري", required: true, type: "text", group: "المشتري" },
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <table class="tbl">
      <tr><td class="th">البائع</td><td><b>الاسم:</b> {{sellerName}} — <b>الرقم الشخصي/السجل:</b> {{sellerId}} — <b>العنوان:</b> {{sellerAddress}} — <b>الهاتف:</b> {{sellerPhone}}</td></tr>
      <tr><td class="th">المشتري</td><td><b>الاسم:</b> {{buyerName}} — <b>الرقم الشخصي/السجل:</b> {{buyerId}} — <b>العنوان:</b> {{buyerAddress}} — <b>الهاتف:</b> {{buyerPhone}}</td></tr>
    </table>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>يضمن البائع خلوّ المبيع من العيوب الخفية التي تنقص من قيمته أو من الانتفاع به وفق أحكام القانون المدني القطري، ما لم يُتفق على الإعفاء من الضمان في حدود ما يجيزه القانون ودون أن يعلم البائع بالعيب ويكتمه.</li>
...
export const SALE_QA_EN: ContractTemplate = {
  id: 15102,
  slug: "qa-sale-movable-en",
  title: "Movable Property Sale Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "contractCity", label: "Place/City of Execution", required: true, type: "text", group: "Contract Info", placeholder: "Doha" },

    { key: "sellerName", label: "Seller Name", required: true, type: "text", group: "Seller" },
    { key: "sellerId", label: "Seller QID / CR", required: true, type: "text", group: "Seller" },
    ...
    { key: "buyerId", label: "Buyer QID / CR", required: true, type: "text", group: "Buyer" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004).</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Seller:</b> {{sellerName}}<br/><b>QID/CR:</b> {{sellerId}}<br/><b>Address:</b> {{sellerAddress}}<br/><b>Contact:</b> {{sellerPhone}}</div>
      <div><b>Buyer:</b> {{buyerName}}<br/><b>QID/CR:</b> {{buyerId}}<br/><b>Address:</b> {{buyerAddress}}<br/><b>Contact:</b> {{buyerPhone}}</div>
    </div>
  ...
  <div class="sec"><h3>3. Price & Payment</h3><div class="box">
    ...
    <div class="muted">This Agreement is binding on the Parties; neither may unilaterally rescind or vary it save by mutual consent or on grounds provided by the Civil Code.</div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty of Title & Latent Defects</h3><div class="box">
    ...
    <div class="muted">The Seller warrants quiet possession against dispossession and third-party claims, and is liable for latent defects that reduce the item's value or fitness for use under the Civil Code, save for a lawful exclusion of liability where the Seller did not knowingly conceal the defect.</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Dispute Resolution</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the State of Qatar apply and the competent court in {{contractCity}} has jurisdiction unless the Parties agree in writing to arbitration.</div>
