// lib/contracts/qa/deposit.ts
// عقد وديعة وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الوديعة.
...
export const DEPOSIT_QA_AR: ContractTemplate = {
  id: 16001,
  slug: "qa-deposit-ar",
  title: "عقد وديعة (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الوديعة</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">تُنقَل بالوديعة حيازة الشيء إلى المودَع لديه ليتولّى حفظه على أن يردّه عيناً عند طلب المودِع، عملاً بأحكام الوديعة في القانون المدني القطري.</div>
  </div>
...
export const DEPOSIT_QA_EN: ContractTemplate = {
  id: 16002,
  slug: "qa-deposit-en",
  title: "Deposit / Bailment Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "depositorId", label: "Depositor QID / CR", required: true, type: "text", group: "Depositor" },
    ...
    { key: "custodianId", label: "Depositary QID / CR", required: true, type: "text", group: "Depositary" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Deposit provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Depositor:</b> {{depositorName}} — QID/CR: {{depositorId}} — {{depositorAddress}}</div>
    <div><b>Depositary:</b> {{custodianName}} — QID/CR: {{custodianId}} — {{custodianAddress}}</div>
  </div></div>
