// lib/contracts/qa/lease.ts
// عقد إيجار وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الإيجار،
// مع مراعاة قانون إيجار العقارات رقم 4 لسنة 2008 فيما يخضع له.
...
export const LEASE_QA_AR: ContractTemplate = {
  id: 15201,
  slug: "qa-lease-ar",
  title: "عقد إيجار (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "governingLaw", label: "القانون الواجب التطبيق", required: true, type: "text", group: "أحكام إضافية", placeholder: QA.governingLawAr },
    { key: "disputeCity", label: "الاختصاص المكاني (المحكمة)", required: true, type: "text", group: "أحكام إضافية", placeholder: QA.defaultCourtCityAr },
...
<div class="doc rtl">
  ...
  <div class="box">
    ...
    <div class="clause">يلتزم المستأجر باستعمال المأجور فيما أُعدّ له وبما لا يخالف الغرض المتفق عليه، وأن يبذل في المحافظة عليه عناية الشخص المعتاد، عملاً بأحكام الإيجار في القانون المدني القطري.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>ينتهي الإيجار بانقضاء مدّته، مع مراعاة أحكام قانون إيجار العقارات رقم 4 لسنة 2008 واختصاص لجنة فض المنازعات الإيجارية فيما يخضع له.</li>
...
export const LEASE_QA_EN: ContractTemplate = {
  id: 15202,
  slug: "qa-lease-en",
  title: "Lease Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "lessorId", label: "Lessor QID / CR", required: true, type: "text", group: "Lessor" },
    ...
    { key: "lesseeId", label: "Lessee QID / CR", required: true, type: "text", group: "Lessee" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004), Lease provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Lessor:</b> {{lessorName}}<br/><b>QID/CR:</b> {{lessorId}}<br/><b>Address:</b> {{lessorAddress}}</div>
      <div><b>Lessee:</b> {{lesseeName}}<br/><b>QID/CR:</b> {{lesseeId}}<br/><b>Address:</b> {{lesseeAddress}}</div>
    </div>
  </div></div>
  ...
  <div class="sec"><h3>4. Maintenance & Termination</h3><div class="box">
    <div class="muted">
      ...
      (d) On expiry, the Lessee returns the premises in their received condition, subject to fair wear and tear; the Property Leasing Law No. 4 of 2008 and the Rent Disputes Committee apply to leases within their scope.
    </div>
  </div></div>
  ...
  <div class="sec"><h3>5. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">If left blank, the laws of the State of Qatar apply and the competent court in {{contractCity}} has jurisdiction.</div>
  </div></div>
