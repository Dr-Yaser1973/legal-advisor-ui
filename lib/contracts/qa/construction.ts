// lib/contracts/qa/construction.ts
// عقد مقاولة وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام المقاولة،
// والضمان العشري للمباني والمنشآت الثابتة (المواد 711–715: مسؤولية المقاول والمهندس المتضامنة،
...
export const CONSTRUCTION_QA_AR: ContractTemplate = {
  id: 15401,
  slug: "qa-construction-ar",
  title: "عقد مقاولة (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام المقاولة والضمان العشري</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">إذا تعهّد المقاول بتقديم مادة العمل كلها أو بعضها كان مسؤولاً عن جودتها ويضمنها لرب العمل، عملاً بأحكام المقاولة في القانون المدني القطري.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      ...
      <li>في مقاولات المباني والمنشآت الثابتة يضمن المقاول والمهندس متضامنين ما يقع خلال عشر سنوات من تهدّم كلي أو جزئي أو عيب يهدّد متانة البناء وسلامته، ولو كان الخلل ناشئاً عن عيب في الأرض. وهذا الضمان من النظام العام فلا يجوز الاتفاق على إعفائه أو الحدّ منه (المواد 711–715 من القانون المدني القطري).</li>
    </ol>
  </div>
...
export const CONSTRUCTION_QA_EN: ContractTemplate = {
  id: 15402,
  slug: "qa-construction-en",
  title: "Construction / Works Contract (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "ownerId", label: "Owner QID / CR", required: true, type: "text", group: "Owner" },
    ...
    { key: "contractorId", label: "Contractor CR / QID", required: true, type: "text", group: "Contractor" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Muqawala; decennial liability, Arts. 711–715.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div class="row">
      <div><b>Owner:</b> {{ownerName}}<br/><b>QID/CR:</b> {{ownerId}}<br/><b>Address:</b> {{ownerAddress}}</div>
      <div><b>Contractor:</b> {{contractorName}}<br/><b>QID/CR:</b> {{contractorId}}<br/><b>Address:</b> {{contractorAddress}}</div>
    </div>
  </div></div>
  ...
  <div class="sec"><h3>5. Warranty & Liability</h3><div class="box">
    ...
    <div class="muted">For buildings and fixed structures, the Contractor and the engineer are jointly liable for total or partial collapse and for defects threatening the building's stability and safety for ten years from handover — even where the fault stems from a defect in the ground. This liability is a matter of public policy and may not be excluded or limited by agreement (Arts. 711–715 Qatari Civil Code).</div>
  </div></div>
