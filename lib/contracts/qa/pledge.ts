// lib/contracts/qa/pledge.ts
// عقد رهن حيازي (ضمان دين) وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الرهن الحيازي.
// وللرهن التجاري على المنقولات يُراعى قانون التجارة رقم 27 لسنة 2006.
...
export const PLEDGE_QA_AR: ContractTemplate = {
  id: 15701,
  slug: "qa-pledge-ar",
  title: "عقد رهن حيازي (قطر) – عربي",
  lang: "ar",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
...
<div class="doc rtl">
  <div class="header">
    ...
    <div class="subtitle">مصاغ وفق القانون المدني القطري رقم 22 لسنة 2004 — أحكام الرهن الحيازي</div>
    <div class="meta">
  ...
  <div class="box">
    ...
    <div class="clause">لا يتمّ الرهن الحيازي إلا بتسليم المرهون إلى المرتهن أو إلى عدلٍ يتفق عليه الطرفان، ويبقى المرهون محبوساً ضماناً للدين وملحقاته، عملاً بأحكام الرهن الحيازي في القانون المدني القطري.</div>
  </div>
  ...
  <div class="box">
    ...
    <ol class="ol">
      <li>يخضع هذا العقد ويُفسَّر وفق: <b>{{governingLaw}}</b> (وللرهن التجاري على المنقولات تُراعى أحكام قانون التجارة رقم 27 لسنة 2006).</li>
...
export const PLEDGE_QA_EN: ContractTemplate = {
  id: 15702,
  slug: "qa-pledge-en",
  title: "Possessory Pledge Agreement (Qatar) — English",
  lang: "en",
  group: "PRO",
  jurisdiction: "QA",
  fields: [
    ...
    { key: "pledgorId", label: "Pledgor QID / CR", required: true, type: "text", group: "Pledgor" },
    ...
    { key: "pledgeeId", label: "Pledgee QID / CR", required: true, type: "text", group: "Pledgee" },
...
<div class="doc" dir="ltr" lang="en">
  ...
  <div class="hdr">
    <div>
      ...
      <div class="muted">Governed by the Qatari Civil Code (Law No. 22 of 2004) — Possessory Pledge provisions.</div>
    </div>
    <div class="meta">
  ...
  <div class="box"><div class="sec"><h3>1. Parties</h3>
    <div><b>Pledgor:</b> {{pledgorName}} — QID/CR: {{pledgorId}} — {{pledgorAddress}}</div>
    <div><b>Pledgee (Creditor):</b> {{pledgeeName}} — QID/CR: {{pledgeeId}} — {{pledgeeAddress}}</div>
  </div></div>
  ...
  <div class="sec"><h3>6. Governing Law & Special Terms</h3><div class="box">
    ...
    <div class="muted">A commercial pledge over movable assets is additionally subject to the Commercial Law (Law No. 27 of 2006).</div>
  </div></div>
